...
<section id="contentLeft">
	...
	<h2 class="titleDescription"><a class="menuitem" href="Canteen.php"><span>&nbsp;</span>Canteen</a></h2>
	...
	<p>&nbsp;</p>
                ...
                <p>&nbsp;</p>
                <div align="justify">
                  <p><img src="images/img/canteen.jpg" width="494" height="275" /></p>
                  <p class="style3">&nbsp; </p>
                  <p class="style3">College years are not only about working hard and burning the midnight oil but also about making new friends and having fun. The  cafeteria is designed to create a comfortable environment where you can discuss ideas while you enjoy a goodmeal. The larger mess hall is equipped to serve lunch and dinner for all students between scheduled timings. We also serve a variety of snacks along with North and South Indian dishes at affordable prices.</p>
                </div>
</section>
			<!--- contentLeft -->
  <section id="sideBar">
