...
<tr background="images/dropdownBg.png">
    ...
    <td colspan="3" height="685" width="80%" valign="top"><div align="center">
      ...
      <table width="1155" border="0"  bgcolor="#FFFFCA">
          ...
          <tr>
            <td colspan="6">
			<table width="1133" border="1" cellspacing="0" cellpadding="0">
              <tr>
                <th width="59" scope="col"><span class="style60">FORM NO. </span></th>
                <th width="164" scope="col"><span class="style60">NAME</span></th>
                <th width="118" scope="col"><span class="style60">EMAIL</span></th>
                <th width="98" scope="col"><span class="style60">CONTACT</span></th>
                <th width="89" scope="col"><span class="style60">COLLEGE</span></th>
                <th width="127" scope="col"><span class="style60">ADDRESS</span></th>
                <th width="118" scope="col"><span class="style60">EVENT</span></th>
                <th width="80" scope="col"><span class="style60">ENTRY</span></th>
                <th width="155" scope="col"><span class="style60">ACCOMODATION</span></th>
