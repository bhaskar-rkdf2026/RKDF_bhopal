...
<section id="contentLeft">
	...
	<table>
        ...
        <tr>
            <td>Faculty of Pharmaceutical Sciences, RKDF University Bhopal MP</td>
            <td>
                <img src="Santram Lodhi.jfif" alt="Dr. Santram Lodhi"><br>
        ...
        <tr>
            ...
            <td>
                <img src="dean-photo2.jpg" alt="Dean Photo"><br>
                <strong>Name:</strong> Dr. Michael Brown <br>
                <strong>Designation:</strong> Dean of Engineering
                <br><br>
                <img src="hod-photo2.jpg" alt="HOD Photo"><br>
                <strong>Name:</strong> Dr. Emma White <br>
                <strong>Designation:</strong> HOD of Electrical Engineering
            </td>
        </tr>
