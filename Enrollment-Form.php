...
<section id="contentLeft">
	...
	<h2 class="titleDescription"><a href="Enrollment-Form.php"><span>&nbsp;</span> Enrollment Form</a></h2>
	<p class="titleDescription">&nbsp;</p>
	<h2 class="style6"> <strong><em><img src="images/img/enrollment.jpg" width="268" height="188" /></em></strong></h2>
	<p class="style6">&nbsp;</p>
	<p class="style6"> Enrollment Number:- </p>
	</div>
