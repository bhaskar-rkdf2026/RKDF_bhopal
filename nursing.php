...
<head>
    ...
    <meta name="keywords"
        content="Best university in bhopal,rkdf nursing, nursing,rkdf university nursing " />
...
<section id="contentLeft">
	...
	<h2 class="titleDescription"><a href="#"><font color="#6C006C"> UNIVERSITY COLLEGE OF NURSING </font><br/>
	</a></h2>
	
	<table width="1122" height="252" border="1" cellpadding="0" cellspacing="0">
	  <tr>
          <td colspan="6"><a href="https://rkdf.ac.in/approval/INC_2022-23.pdf" target="_blank" > <span class="style8"> ( INC APPROVED ) </span></a> |<a href="https://rkdf.ac.in/approval/nursing_2022.pdf" target="_blank" > <span class="style8"> ( MPNRC APPROVED ) </span></a></td>
        </tr>		
      <tr bgcolor="#9A9A4E">
        <td width="213" height="26"><span class="style1">Courses</span></td>
        <td width="83"><span class="style1">Year</span></td>
        <td width="63"><span class="style1">Seats</span></td>
        <td width="281"><span class="style1">Eligibility</span></td>
      </tr>
       <tr>
        <td width="213" height="76"><span class="style6">B.Sc. (Nursing)</span></td>
        <td width="83"><span class="style6">4 Years </span></td>
        <td width="63"><span class="style6">50</span></td>
        <td width="281" class="style6">Passed in 10+2 or equivalent examination in science with PCB and English subjects with at least 45% and must have minimum age of 17 yrs and maximum of 35 yrs.</td></tr>
<tr>
        <td width="213" height="68"><span class="style6">GNM (Nursing)</span></td>
        <td width="83"><span class="style6">3 Years </span></td>
        <td width="63"><span class="style6">50</span></td>
        <td width="281" class="style6">Passed in 10+2 or equivalent examination in any subjects with at least 40% and must have minimum age of 17 yrs and maximum of 35 yrs.</td></tr>
<tr>
        <td width="213" height="64"><span class="style6">Post Basic B.Sc. (Nursing)</span></td>
        <td width="83"><span class="style6">2 Years </span></td>
        <td width="63"><span class="style6">60</span></td>
        <td width="281" class="style6">Passed in 10+2 or examination or equivalent and GNM course or equivalent with at least 45%.
</td></tr>
    </table>
	<p>&nbsp;</p>
	<p align="justify"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
