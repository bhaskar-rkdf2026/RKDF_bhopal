    ...
    <section id="content" class="wrapper ">
        ...
        <section id="contentLeft">
            <div id="collegeDetail">
                <h2 class="titleDescription"><a href="Computer-Application.php"> Faculty of Computer Science &amp;
                        Application </a></h2>
                ...
                <blockquote>
                    ...
                    <table width="1122" border="1" cellpadding="0" cellspacing="0">
                        <tr>
                            <td colspan="5"> <span class="style7">College : &nbsp;SRI SATYA SAI COLLEGE OF ENGINEERING
                                    (SSSCE ) &nbsp;<span class="style8">(AICTE APPROVED)</span>
                                    &nbsp;&nbsp;</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            </td>
                        </tr>
                        <tr bgcolor="#9A9A4E">
                        ...
                        <tr>
                            <td width="213"><span class="style6">MCA</span></td>
                            <td width="83"><span class="style6">6 sem</span></td>
                            <td width="71"><span class="style6">60</span></td>
                            <td width="273" rowspan="4"><span class="style6">Passed BCA/ Bachelor Degree in Computer
                                    Science Engineering or equivalent Degree. OR Passed B.Sc./ B.Com./ B.A. with
                                    Mathematics at 10+2 Level or at Graduation Level (with additional bridge Courses as
                                    per the norms of the concerned University). Obtained at least 50% marks (45% marks
                                    in case of candidates belonging to reserved category) in the qualifying Examination.
                                </span></td>
                        ...
                        <tr>
                            <td width="213"><span class="style6">BCA</span></td>
                            <td width="83"><span class="style6">6 sem</span></td>
                            <td width="71"><span class="style6">60</span></td>
                            <td width="273" rowspan="2"><span class="style6">Passed 10+2 or equivalent examination in science or commerce subjects.</span></td>
                        </tr>
                        <tr>
                            <td width="213"><span class="style6">PGDCA</span></td>
                            <td width="83"><span class="style6">1 Year</span></td>
                            <td width="71"><span class="style6"> -- </span></td>
                            <td width="273" rowspan="2"><span class="style6">Graduate with minimum 50% marks or equivalent grade points.</span></td>
                        </tr>
                        <tr>
                            <td width="213"><span class="style6">DCA</span></td>
                            <td width="83"><span class="style6">1 Year</span></td>
                            <td width="71"><span class="style6"> -- </span></td>
                            <td width="273"><span class="style6">Passed 10+2 or equivalent examination in any subjects.</span></td>
                        </tr>
                    </table>
                    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
                </blockquote>
