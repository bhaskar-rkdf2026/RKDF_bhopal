    ...
    <section id="content" class="wrapper ">
        ...
        <section id="contentLeft">
            <div id="collegeDetail">
                ...
                <ul class="style5">
                    <li type="square">
                        <div align="justify">To build human resource competence in teaching, research and technology /
                            knowledge sharing.</div>
                    </li>
                    <div align="justify"><br />
                    </div>
                    <li type="square">
                        <div align="justify">To institutionalize appropriate changes in course curricular and delivery
                            systems to accomodate concerns and aspirations of all stake- holders.</div>
                    </li>
                    <div align="justify"><br />
                    </div>
                    <li type="square">
                        <div align="justify">To strengthen partnership with national and foreign institutions especially
                            south–south cooperation for sustainable higher education and research.</div>
                    </li>
                    <div align="justify"><br />
                    </div>
                    <li type="square">
                        <div align="justify">To promote  gender equity and provide quality and relevent education
                            through institutional network.</div>
                    </li>
                    <div align="justify"><br />
                    </div>
                </ul>
