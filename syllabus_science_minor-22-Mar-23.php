            ...
            <ul>
                <li class="style9">
                    <table width="640" height="621" border="1">
                        ...
                        <tr>
                            <td colspan="2"><a href="syllabus/NEP/MINOR/Minor_Physic.pdf"
                                    target="_blank"><strong> B.SC (PHYSICS)</strong></a></td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
                            <td colspan="2"><a href="syllabus/NEP/MINOR/Minor_Zoology.pdf"
                                    target="_blank"><strong>B.SC (ZOOLOGY)</strong></a></td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
                            <td colspan="2"><a href="syllabus/NEP/MINOR/Minor_CHEM.pdf"
                                    target="_blank"><strong>B.SC (CHEMISTRY) </strong></a></td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
                            <td colspan="2"><a href="syllabus/NEP/MINOR/Minor_EVS.pdf"
                                    target="_blank"><strong>B.SC (ENVIRONMENTAL)</strong></a></td>
                            <td>&nbsp;</td>
                        </tr>
                       
                        <tr>
                            <td colspan="2"><a href="syllabus/NEP/MINOR/Minor_Botany.pdf"
                                    target="_blank"><strong>B.SC (BOTANY)</strong></a></td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
                            <td colspan="2"><a href="syllabus/NEP/MINOR/Minor_Micro.pdf"
                                    target="_blank"><strong>B.SC (MICROBIOLOGY)</strong></a></td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
                            <td colspan="2"><a href="syllabus/NEP/MINOR/Minor_Mathamatic.pdf"
                                    target="_blank"><strong>B.SC (MATHEMATICS)</strong></a></td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
                            <td colspan="2"><a href="syllabus/NEP/MINOR/Minor_Biotech.pdf"
                                    target="_blank"><strong>B.SC (BIOTECHNOLOGY)</strong></a></td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
                            <td colspan="2"><a href="syllabus/NEP/MINOR/Minor_CS.pdf"
                                    target="_blank"><strong>B.SC (COMPUTER SCIENCE)</strong></a></td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
                            <td colspan="2"><a href="syllabus/NEP/MINOR/Minor_Forensic.pdf"
