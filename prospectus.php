...
$eyebrow      = !empty($pRow['eyebrow'])       ? $pRow['eyebrow']       : 'ADMISSIONS · PROSPECTUS';
$mainTitle    = !empty($pRow['page_title'])    ? $pRow['page_title']    : 'Download Official Prospectus 2026-27';
$heroSubtitle = !empty($pRow['hero_subtitle']) ? $pRow['hero_subtitle'] : 'Comprehensive information brochure covering campus facilities, placement records, fee structures, and course details.';
