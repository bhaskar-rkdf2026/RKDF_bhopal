    ...
    <section id="content" class="wrapper ">
        ...
        <section id="contentLeft">
            <div id="collegeDetail">
                ...
                <p class="titleDescription">&nbsp; </p>
                <p><a href="#"></a></p>
                <p><a href="circular/Faculity Requirement by 26-May-2025.pdf" target="_blank"><strong><img src="images/bullet.png" style="width: 20px;height: 20px;"/> Various Faculty
                            Positions required in the Department(s) of Faculty of Agriculture, Science, Social Science, Law,
                            Management, Education, Commerce, Agriculture, Ayurveda and Homeopathy of RKDF University, Bhopal -
                            Apply </strong></a> </p>

                <p><a href="circular/Faculty Required.pdf" target="_blank"><strong><img src="images/bullet.png" style="width: 20px;height: 20px;"/> Faculty Required in Different
                            Department of University </strong></a> </p>
                <p><a href="circular/Advertisement_Application Form.pdf" target="_blank"><strong><img src="images/bullet.png" style="width: 20px;height: 20px;"/> POST DOCTORAL
                            FELLOWSHIP on LIVE PROJECTS June-2022(Advertisment & Application Form) </strong></a> </p>
                <p><a href="circular/ADV Bio-diesel Revised.pdf" target="_blank"><strong><img src="images/bullet.png" style="width: 20px;height: 20px;"/> Walk-In Interview Revised
                            (Technician for Bio-diesel Plant) </strong></a></p>
                <p><a href="circular/ADV Bio-diesel.pdf" target="_blank"><strong><img src="images/bullet.png" style="width: 20px;height: 20px;"/> Walk-In Interview (Technician for
                            Bio-diesel Plant) </strong></a></p>
                <p><a href="circular/Revised Add Ayurveda.pdf" target="_blank"><strong> <img src="images/bullet.png" style="width: 20px;height: 20px;"/> Walk-In Interview In Ayurveda
                            College (Revised Schedule) </strong></a></p>
                <p><a href="circular/Ayurveda Requirement.pdf" target="_blank"><strong><img src="images/bullet.png" style="width: 20px;height: 20px;"/> Walk-In Interview In Ayurveda
                            College</strong></a></p>
                <p><a href="images/add/architect.pdf" target="_blank"><strong><img src="images/bullet.png" style="width: 20px;height: 20px;"/> Faculty Required for M.Arch and B.Arch
                        </strong></a></p>
                <p><a href="images/add/Latter.pdf" target="_blank"><strong><img src="images/bullet.png" style="width: 20px;height: 20px;"/> Walk-In Interview (VACANCY) </strong></a></p>
                <p><a href="images/add/vacancy.pdf" target="_blank"><strong><img src="images/bullet.png" style="width: 20px;height: 20px;"/> Walk-In Interview (VACANCY).</strong></a>
                </p>
                <p><a href="images/add/add_2017.pdf" target="_blank"><strong><img src="images/bullet.png" style="width: 20px;height: 20px;"/> Walk-In Interview (VACANCY).</strong></a>
                </p>
                <p><a href="homeopathy add.pdf" target="_blank"><strong><img src="images/bullet.png" style="width: 20px;height: 20px;"/> Walk-In Interview in Homoeopathy.</strong></a>
                </p>
                <p><a href="images/add/add_int.pdf" target="_blank"><strong><img src="images/bullet.png" style="width: 20px;height: 20px;"/> Walk-In Interview in Life
                            Science.</strong></a></p>
                <p><a href="images/add/urgently_required.pdf" target="_blank"><strong><img src="images/bullet.png" style="width: 20px;height: 20px;"/> Application Invited for the
        ...
        <section id="secfoot">
            <div class="wrapper">
                <p>
                    &copy; copyright <?php
				echo date("Y");
				?> - RKDF UNIVERSITY. All rights reserved.
                </p>
                <P>
