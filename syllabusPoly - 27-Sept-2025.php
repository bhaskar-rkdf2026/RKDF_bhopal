...
<h2 class="titleDescription"><a href=""> POLYTECHNIC (ALL BRANCH) Syllabus</a></h2>
                  ...
                  <li class="style9">
                    <table width="200" border="1">
                      <tr>
                        ...
                        DIPLOMA POLYTECHNIC ( 1st YEAR ALL BRANCH )</span></td>
                        <td width="167">&nbsp;</td>
                        <td width="73">&nbsp;</td>
                      </tr>
                      <tr>
                        <td colspan="3"><a href="syllabus/Technical syllabus/polytechnic.pdf" target="_blank"><strong> &nbsp;  POLYTECHNIC (Diploma) &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </strong></a></td>
                      </tr>
                      <tr>
                        <td width="388"><span class="style3"><br />
                        DIPLOMA POLYTECHNIC ( 1ST TO 6TH SEM ME BRANCH )</span></td>
                        <td width="167">&nbsp;</td>
                        <td width="73">&nbsp;</td>
                      </tr>
					   <tr>
                        <td colspan="3"><a href="syllabus/Technical syllabus/POLY ME BRANCH.pdf" target="_blank"><strong> &nbsp;  POLYTECHNIC (Diploma) ME&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </strong></a></td>
                      </tr>
					  <tr>
                        <td width="388"><span class="style3"><br />
                        DIPLOMA POLYTECHNIC ( 3RD TO 6TH SEM ALL BRANCH )</span></td>
                        <td width="167">&nbsp;</td>
                        <td width="73">&nbsp;</td>
                      </tr>
					   <tr>
                        <td colspan="3"><a href="syllabus/Technical syllabus/poly all branch 3rd to 6th.pdf" target="_blank"><strong> &nbsp; POLYTECHNIC (Diploma)  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </strong></a></td>
                      </tr>
					<!--   <tr>
                        <td width="388"><span class="style3"><br />
                       DIPLOMA POLYTECHNIC ( IIIrd YEAR ALL BRANCH ) </span></td>
                        <td width="167">&nbsp;</td>
                        <td width="73">&nbsp;</td>
                      </tr>
                      <tr>
                        <td colspan="2"><a href="" target="_blank"><strong>&nbsp; POLYTECHNIC (Diploma) </strong></a></td>
                        <td>&nbsp;</td>
                      </tr>-->
                      <tr>
                        <td colspan="2">&nbsp;</td>
