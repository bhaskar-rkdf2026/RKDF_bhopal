    ...
    <section id="content" class="wrapper ">
        ...
        <section id="contentLeft">
            <div id="collegeDetail">
                <h2 class="titleDescription"><a href="#">FACULTY OF AGRICULTURE </a></h2>
                <blockquote>
                    <table width="1122" border="1" cellpadding="0" cellspacing="0">
                        <tr>
                            <td colspan="6"> <span class="style7">
                                </span></td>
                        </tr>
                        <tr bgcolor="#9A9A4E">
                            <td width="135" height="37"><span class="style1">Courses</span></td>
                            <td width="107"><span class="style1">Sem/Year</span></td>
                            <td width="78"><span class="style1">Seats</span></td>
                            <td width="320"><span class="style1">Eligibility</span></td>
                        </tr>
		
		                 <tr>
                            <td width="213" height="84"><span class="style6">B.Sc.(Hons) Agriculture</span></td>
                            <td width="83"><span class="style6">08 Sem</span></td>
                            <td width="71"><span class="style6">120</span></td>
                   <td width="273" class="style6">Passed in 10+2 or equivalent examination either in science with PCM/PCB.<br /> <span class="style12">OR</span> <br />agriculture subjects with at least 50% for Gen and OBC category.(45% for SC/ST category).</td>

                        </tr>
						 <tr>
                            <td width="213" height="65"><span class="style6">B.Tech. Agriculture</span></td>
                            <td width="83"><span class="style6">08 Sem</span></td>
                            <td width="71"><span class="style6">60</span></td>
                            <td width="273" class="style6">Passed in 10+2 or equivalent examination in science with PCM with English as one subjects with at least 45% (40% for reserved category).</td>

                        </tr>
						<!-- <tr>
                            <td width="213" height="84"><span class="style6">M.Sc. Agriculture</span></td>
                            <td width="83"><span class="style6">04 Sem</span></td>
                            <td width="71"><span class="style6">60</span></td>
                            <td width="273" class="style6">Passed in Bachelor’s degree in Agriculture.<br /> <span class="style12">OR</span><br />  Horticulture or Forestry or other relevant subjects from any Recognized University by UGC/AIU with at least 60%.</td>

                        </tr>
						 <tr>
                            <td width="213"><span class="style6">Diploma in Agriculture</span></td>
                            <td width="83"><span class="style6">1 Year </span></td>
                            <td width="71"><span class="style6">60</span></td>
                            <td width="273" class="style6">Passed 10+2 examination Science with Physics, Mathematics and Chemistry /Biology. <br /><span class="style12">OR</span> <br />
                            10+2 Agriculture obtained at least 45%(40% for reserved category) in the above subjects taken together.</td>
