...
try {
    ...
    $pagesData = [
        ...
        ['page_slug' => 'alumni', 'page_title' => 'Alumni Network & Global Association', 'category' => 'About Us', 'eyebrow' => 'ALUMNI NETWORK · RKDF UNIVERSITY BHOPAL', 'hero_subtitle' => 'Connecting graduates across the globe — building strong professional networks, career opportunities, and lifelong university bonds.', 'intro_heading' => 'Welcome to RKDF University Alumni Association', 'intro_text' => 'Any institution\'s Alumni are key to its growth. Stay connected with fellow graduates, explore career opportunities, attend exclusive reunions, and enjoy lifelong membership benefits.'],
        ['page_slug' => 't&p', 'page_title' => 'Training & Placement Cell', 'category' => 'Academics', 'eyebrow' => 'CAREER DEVELOPMENT · RKDF UNIVERSITY BHOPAL', 'hero_subtitle' => 'Assisting students in achieving top placement offers, internships, pre-placement training, and industry-academia interactions.', 'intro_heading' => 'Welcome to RKDF University Training & Placement Cell', 'intro_text' => 'The Training and Placement (T&P) Cell plays a major role in shaping the corporate readiness of our students.'],
        ['page_slug' => 'prospectus', 'page_title' => 'University Prospectus & Information Brochure 2026-27', 'category' => 'Admissions', 'eyebrow' => 'ADMISSIONS · PROSPECTUS 2026-27', 'hero_subtitle' => 'Comprehensive information brochure covering campus facilities, placement records, fee structures, and course details.', 'intro_heading' => 'Official RKDF University Information Prospectus', 'intro_text' => 'Explore the complete RKDF University Prospectus featuring academic programs across 16 faculties.'],
        ['page_slug' => 'careers', 'page_title' => 'Careers & Academic Recruitment', 'category' => 'About Us', 'eyebrow' => 'CAREERS · RKDF UNIVERSITY BHOPAL', 'hero_subtitle' => 'Join the academic and research faculty at RKDF University Bhopal. Explore current walk-in interviews, research project fellowships, and faculty openings.', 'intro_heading' => 'Current Openings & Walk-In Interviews', 'intro_text' => 'RKDF University invites applications from dynamic, qualified scholars and faculty for teaching and research positions.']
    ];
