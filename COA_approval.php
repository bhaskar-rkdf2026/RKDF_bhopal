    ...
    <section id="content" class="wrapper ">
        ...
        <section id="contentLeft">
            <div id="collegeDetail">
                <h2 class="titleDescription"><a href=""><span>&nbsp;</span>COA Approval 2025-26</a></h2>
                <p class="titleDescription">&nbsp;</p>
                <h2 class="style6">
                    <div style="float: left;">
                        <img src="images/coa.jpg" width="184" height="263" />
                    </div>
                </h2>
                <p class="style6">&nbsp;</p>
            </div>
            ...
            <p style="padding-bottom: 12px;padding-top:12px;margin-bottom: 12px">
                <br><br><br>
                <label style="font-size: x-large;font-weight: 600;"> Year 2026-27</label>
            </p>
            <p>
                <a href="approval/AICTE_26-27/MP11 D_20260506144209-COA_DIPLOMA.pdf"
                    target="_blank"><strong><img src="images/bullet.png"/>&nbsp;&nbsp;Architecture - Diploma in Architecture - Extension of approval
                        for the academic (EoA) - 2026-27</strong></a>
            </p>
            <p>&nbsp;</p>
            ...
            <p style="padding-bottom: 12px;padding-top:12px;margin-bottom: 12px">
                <br><br><br>
                <label style="font-size: x-large;font-weight: 600;"> Year 2025-26</label>
            </p>
            <p>
                <a href="approval/COA_2025_26/MP11 PG_20250708210501-MArch-FOA25-26.pdf"
                    target="_blank"><strong><img src="images/bullet.png"/>  &nbsp;&nbsp;Architecture - Master of Architecture (M.Arch) Degree Course -
                        Extension of approval
                        for the academic (EoA) 2025-26</strong></a>
            </p>
            <p>&nbsp;</p>

            <p><a href="approval/COA_2025_26/MP11_20250704190616-BArch-FOA25-26.pdf"
                    target="_blank"><strong><img src="images/bullet.png"/>&nbsp;&nbsp;Architecture - Bachelor of Architecture (B.Arch) Degree Course -
                        Extension of approval
                        for the academic (EoA) 2025-26</strong></a></p>
            <p>&nbsp;</p>
            <p><a href="approval/COA_2025_26/MP11-D_20250501205856-2025-26.pdf"
                    target="_blank"><strong><img src="images/bullet.png"/>&nbsp;&nbsp;Architecture - Diploma in Architecture - Extension of approval
                        for the academic (EoA) 2025-26</strong></a></p>
            <p>&nbsp;</p>
            ...
            <p style="padding-bottom: 12px;padding-top:12px;margin-bottom: 12px">
                <label style="font-size: x-large;font-weight: 600;"> Year 2024-25</label>
            </p>
            <p>
                <a href="approval/COA_2024_25/COA_MP11-Approval letter Diploma in Architecture Session 2024-25.pdf"
                    target="_blank"><strong><img src="images/bullet.png"/>&nbsp;&nbsp;Architecture - Diploma in Architecture - Extension of approval
                        for the academic (EoA) 2024-25</strong></a>
            </p>
            <p>&nbsp;</p>
            <p><a href="approval/COA_2024_25/COA_MP11_20240517132424_Bachelor_of_Architecture_2024-25.pdf"
                    target="_blank"><strong><img src="images/bullet.png"/>&nbsp;&nbsp;&nbsp;Architecture - Bachelor of Architecture - Extension of
                        approval for the academic (EoA) 2024-25</strong></a></p>
            <p>&nbsp;</p>
            <p><a href="approval/COA_2024_25/COA_Faculity_of_Architecture_MArch_Degree_2024-25.pdf"
                    target="_blank"><strong><img src="images/bullet.png"/>&nbsp;&nbsp;&nbsp;Architecture - M.Arch Degree - Extension of approval for
                        the academic (EoA) 2024-25</strong></a></p>
            <p>&nbsp;</p>
            <p>&nbsp;</p>
            <p>&nbsp;</p>
            <p>&nbsp;</p>
