        ...
        <section id="contentLeft">
            <div id="collegeDetail" style="min-height: 2px !important;">
                <h2 class="titleDescription"><a href="" class="style4">
                        <font color="#FF1111">Board of Governors (Excutive Council)</font>
                    </a> </h2>
            </div>

            <h2 class=""> <strong><em><a href="#"></a></em></strong><img src="images/img/leadership.jfif" /></h2>
            <p><a href="#"  target=_blank"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/img/new24.gif" />
                <span class="style1">&nbsp;&nbsp; Test Detail</span></span></strong></a>&nbsp;</p><p>&nbsp;
            </p>
