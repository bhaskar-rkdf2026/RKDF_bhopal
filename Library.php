    ...
    <section id="content" class="wrapper">
        ...
        <section id="contentLeft">
            <div id="collegeDetail">
                <h2 class="titleDescription"><a href="#"> Faculty of Library and Informational Science</a></h2>
                <p class="titleDescription">&nbsp;</p>
                <blockquote>

                    <table width="656" height="212" border="1" cellpadding="0" cellspacing="0">
                        <tr>
                            <td colspan="6"> <span class="style7">  DEPARTMENT OF RKDF UNIVERSITY, BHOPAL
                                    </span>  </td>
                        </tr>
                        <tr bgcolor="#9A9A4E">
                            <td width="261" height="37"><span class="style1">Courses</span></td>
                            <td width="75"><span class="style1">Sem/Year</span></td>
                            <td width="47"><span class="style1">Seats</span></td>
                            <td width="257"><span class="style1">Eligibility</span></td>
                        </tr>
		 ...
		 <tr>
        <td width="261" height="95"><span class="style6">Bachelor of Library Science (B. Lib)</span></td>
        <td width="75"><span class="style6">1 Years </span></td>
        <td width="47"><span class="style6">40</span></td>
       <td width="257" class="style6">45% marks or equivalent grade points in Bachelor degree of a recognized university.<br /></td>
		 </tr>
<tr>
 <tr>
        <td width="261" height="95"><span class="style6">Master of Library Science(M. Lib)</span></td>
        <td width="75"><span class="style6">1 Years </span></td>
        <td width="47"><span class="style6">40</span></td>
        <td width="257" class="style6">50% or equivalent grade points in Bachelor of Library & Implementation Science/ Bachelor of Library of a recognized university.<br /></td>
 </tr>
<tr>
                    </table>
                    <p class="style14">&nbsp;</p>
