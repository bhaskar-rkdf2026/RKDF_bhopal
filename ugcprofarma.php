...
<section id="contentLeft">
	...
	<h2 class="titleDescription"><a href=""><span>&nbsp;</span> UGC PROFARMA </a></h2>
	<p class="titleDescription">&nbsp;</p>
	<h2 class="style6"> <strong><em><a href="#"></a></em></strong></h2>
	<p class="style6"><img src="images/img/ugc_logo.jpg" width="259" height="194" /></p>
	</div>
                <p>&nbsp;</p>
                <p>&nbsp;</p>
                <p>&nbsp;</p>
                ...
                <ul>
				 <li class="style9"></li>
				                    <li class="style9">
                    <p><a href="images/06/UGC Report submitted on dated 14-03-2013.pdf" target="_blank"><strong> &nbsp;&nbsp; UGC Report submitted on dated 14-03-2013</strong></a></p>
                  </li>
                </ul>
              <div>              </div>
                ...
                <p>&nbsp;</p>
                <p>&nbsp;</p>
				<form  action="ugcprofarma.php" method="post">
          <div class="form_settings">
		  <div>           <span class="style3">Enter Your Comments :</span></div>
            <textarea  class="msgarea" title="Enter Your Comments " rows="5" cols="50" name="msg"></textarea>
            <p align="left" style="padding-top: 15px"><span>&nbsp;</span><input class="msgarea" type="submit" name="Submit" value="  SEND  " /></p>
          </div>
    ...
    mysql_select_db("ugc",$con);
	$qry="insert into comments(msg) values('".$msg."')";
	...
	?>	
		  ...
		  <p align="center">
		    <input type="submit" name="sub" value="SHOW All Comments" />
		      </p>
		</form>
