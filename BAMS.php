...
word-spacing:1px; padding: 3px; text-align:justify; }
...
<section id="contentLeft">
	...
	<h2 class="titleDescription"><a href="http://rkcams.in/" target="_blank"> <font color="#6C006C"> RAM KRISHNA COLLEGE OF AYURVEDA & MEDICAL SCIENCES,RKDF UNIVERSITY </font><br/>
	</a></h2>
	
	<table width="1122" height="153" border="1" cellpadding="0" cellspacing="0">
	  <tr>
          <td colspan="6"><a href="https://rkdf.ac.in/ayurveda/LOP-BAMS%202022-23.pdf" target="_blank" > <span class="style8"> ( NCISM APPROVED ) </span> </a></td>
        </tr>
      <tr bgcolor="#9A9A4E">
        <td width="153" height="36"><span class="style1">Courses</span></td>
        <td width="115"><span class="style1">Years</span></td>
        <td width="91"><span class="style1">Seats</span></td>
        <td width="281"><span class="style1">Eligibility</span></td>
      </tr>
       <tr>
        <td width="153" height="31"><span class="style6">B.A.M.S.</span></td>
        <td width="115"><span class="style6">4.5 years </span></td>
        <td width="91"><span class="style6">100
</span></td>
        <td width="281" class="style6">Passed in 10+2 or equivalent examination in science with PCB and English as compulsory subjects with at least 50% and must have minimum age of 17 yrs.As per the Counselling schelduled by M.P. Ayush Department(for 85%) and Ministry of Ayush,GOI(for 15%) which is based on the Marks obtained in NEET or qualifying exam. </td>
      </tr>
    </table>
	<p>&nbsp;</p>
	<p align="justify"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
