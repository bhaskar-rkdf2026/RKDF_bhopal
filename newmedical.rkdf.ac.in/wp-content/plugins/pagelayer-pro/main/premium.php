...
// Markdown
pagelayer_add_shortcode(PAGELAYER_SC_PREFIX.'_markdown', [
	'name' => __pl('Markdown'),
	'group' => 'other',
	'html' => '<div class="pagelayer-markdown-wrapper">
		<textarea class="pagelayer-markdown-hidden-raw">{{active_markdown_text}}</textarea>
		<div class="pagelayer-markdown-output">{{markdown_rendered}}</div>
	</div>',
	'params' => [
		...
		'markdown_rendered' => [
			'type' => 'hidden',
			'default' => '<div class="pagelayer-markdown-placeholder">' . __pl('Select a Markdown file or enter a URL to load content.') . '</div>',
		],
		'editor_ui_display' => [
			'type' => 'hidden',
			'default' => 'block'
		...
		'markdown_file' => [
			...
			'label' => __pl('File'),
			'req' => ['src_type' => 'upload'],
			'desc' => __pl('To upload .md and .markdown files first Enable Markdown Upload in Pagelayer Settings > General') . 
					'<br><center><button class="pagelayer-elp-button pagelayer-md-sync-file" type="button"><i class="fa fa-refresh"></i> Fetch File Content</button></center>'.
					__pl('Click on it to fetch file content after uploading new file'),
		],
		'markdown_url' => [
			'type' => 'text',
			'label' => __pl('URL'),
			'req' => ['src_type' => 'url'],
			'desc' => '<center><button class="pagelayer-elp-button pagelayer-md-sync-url" type="button"><i class="fa fa-refresh"></i> Fetch URL Content</button></center>'.
					__pl('Click on it to fetch file content after uploading new url'),
		],
		'markdown_text_file' => [
			'type' => 'textarea',
			'label' => __pl('File Content'),
			'default' => '',
			'req' => ['src_type' => 'upload']
		],
		'markdown_text_url' => [
			'type' => 'textarea',
			'label' => __pl('URL Content'),
			'default' => '',
			'req' => ['src_type' => 'url']
		]
	]
