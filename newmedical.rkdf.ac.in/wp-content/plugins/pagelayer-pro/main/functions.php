...
function pagelayer_pro_disable_manual_update_for_plugin($transient){
	...
	$pro_plugin = 'pagelayer-pro/pagelayer-pro.php';
	...
	if(!empty($GLOBALS['pagelayer_pro_is_upgraded'])){
		$pro_version = pagelayer_pro_file_get_version_num($pro_plugin);
	}
...
function pagelayer_add_markdown_mimes($mimes){
	$mimes['md'] = 'text/markdown';
	$mimes['markdown'] = 'text/markdown';
	return $mimes;
}

function pagelayer_allow_markdown_uploads($data, $file, $filename, $mimes){
