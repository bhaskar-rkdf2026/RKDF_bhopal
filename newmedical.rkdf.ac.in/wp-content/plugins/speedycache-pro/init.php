...
if(!defined('SITEPAD')){
	add_filter('site_transient_update_plugins', 'speedycache_pro_disable_manual_update_for_plugin', 99);
	add_filter('pre_site_transient_update_plugins', 'speedycache_pro_disable_manual_update_for_plugin', 99);
	add_filter('transient_update_plugins', 'speedycache_pro_disable_manual_update_for_plugin', 99);
...
function speedycache_pro_load_plugin(){
	...
	// Since v1.4.0 it works for SitePad as well
	...
	// Hook for Cloudflare Page Cache
	add_action('update_option_speedycache_exclude', 'speedycache_pro_cloudflare_exclude_updated', 10, 2);
