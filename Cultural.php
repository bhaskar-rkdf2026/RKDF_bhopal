...
<section id="contentLeft">
	...
	<h2 class="titleDescription"><a href="Cultural.php"><span>&nbsp;</span> Cultural Activities</a></h2>
	<p class="titleDescription">&nbsp;</p>
	<p class="titleDescription"><img src="images/img/ca1.png" width="252" height="167" /><img src="images/img/ca2.png" width="252" height="167" /></p>
	<p class="titleDescription"><img src="images/img/ca3.png" width="252" height="167" /><img src="images/img/ca4.png" width="252" height="167" /></p>
	
	<p class="titleDescription">&nbsp;</p>
	<ul class="style3">
	  <li>
	    <p align="justify">Technical and Cultural Fest</p>
	    <p align="justify">MECHADAY (Annual National Level Technical Seminar organized by Mechanical Dept.)</p>
	    </li>
	  <li>
	    <p align="justify">SANCHARAN (Annual Technical and Cultural Fest)</p>
	    </li>
	  <li>
	    <p align="justify">SAMAGAM (Annual Cultural Fest)</p>
	    </li>
	  <li>
	    <p align="justify">Founder's Day celebrated every year on Feb 14</p>
	    </li>
	  </ul>
	<p class="titleDescription">&nbsp;</p>
	</div>
...
<a class="menuitem" href="Confrence-Seminar.php"><img src="images/bullet.png" /> Confrence &amp; Seminar </a>
<a class="menuitem" href="Games.php"><img src="images/bullet.png" /> Games &amp; Sports </a>
<a class="menuitem" href="Cultural.php"><img src="images/bullet.png" /> Cultural Activities </a>
