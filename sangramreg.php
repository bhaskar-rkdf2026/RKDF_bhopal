...
<table width="90%" align="center" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<form method="post" id="form1" action="sangramregsave.php">
	 
      <table width="952" border="0"  bgcolor="#FFFFCA">
          <tr>
            <td height="69" colspan="4"><div align="center" class="style19 style20">REGISTRATION FORM </div></td>
          </tr>
          <tr>
            <td width="38"><div align="center"><strong>1.</strong></div></td>
            <td width="335"><span class="style27">Name of Captain / Player </span></td>
            <td width="49"><span class="style29">:</span></td>
            <td width="512"><input type="text" name="capname" /></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td><span class="style27">Name of College Institute </span></td>
            <td><span class="style29">:</span></td>
            <td><input type="text" name="college" /></td>
          </tr>
          <tr>
            <td><div align="center"><strong>4.</strong></div></td>
            <td><span class="style27">Name of university </span></td>
            <td><span class="style29">:</span></td>
            <td><input type="text" name="univ" /></td>
          </tr>
          <tr>
            <td><div align="center"><strong>5.</strong></div></td>
            <td><span class="style27">Branch / Course  </span></td>
            <td><span class="style29">:</span></td>
            <td><input type="text" name="branch" /></td>
          </tr>
          <tr>
            <td><div align="center"><strong>6.</strong></div></td>
            <td><span class="style27">Year  </span></td>
            <td><span class="style29">:</span></td>
          ...
          <tr>
            <td height="44"><div align="center"><strong>10.</strong></div></td>
            <td><span class="style27">Name of College Coach/<br />
              Manager's/ Reference By  </span></td>
            <td><span class="style29">:</span></td>
            <td><input type="text" name="coach" /></td>
          </tr>
          <tr>
            <td height="31"><div align="center"><strong>11.</strong></div></td>
            <td><span class="style27">College Coach / Manager's Mob. No.</span></td>
            <td><span class="style29">:</span></td>
            <td><input type="text" name="coachno" /></td>
          </tr>
          <tr>
            <td height="40"><div align="center"><strong>12.</strong></div></td>
			...
			<option value="tabletanis">Table Tanis</option>
