    ...
    <section id="content" class="wrapper ">
        ...
        <section id="contentLeft">
            <div id="collegeDetail">
                <h2 class="titleDescription"><a href="index.php">HOME  </a> / <a href="#"><span>&nbsp;</span> NAAC </a></h2>
				...
				<!-- <p class="titleDescription"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
                        href="approval/NIRF/RKDF University-Overall.pdf" target="_blank"><strong>RKDF University - Overall (NIRF 2023)</strong></a></p>
							   ...
							   <p class="titleDescription"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
                        href="naac/IIQA.pdf" target="_blank"><strong>Institutional Information for Quality Assessment (IIQA)</strong></a></p>
							   <br /><br />
                <p class="titleDescription"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
                        href="#"><strong>Extended Profile</strong></a></p>
                <br /><br />
							
							 <p class="titleDescription"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
                        href="criteria1.php"><strong>Criteria 1: Curricular Aspects</strong></a></p>
							 <br /><br />
							   <p class="titleDescription"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
                        href="criteria2.php"><strong>Criteria 2: Teaching-Learning and Evaluation</strong></a></p>
							   <br /><br />
							  <p class="titleDescription"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
                        href="criteria3.php"><strong>Criteria 3: Research, Innovations and Extension</strong></a></p><br /><br />
							 <p class="titleDescription"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
                        href="criteria4.php" ><strong>Criteria 4: Infrastructure and Learning Resources</strong></a></p><br /><br />

                <p class="titleDescription"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
                        href="criteria5.php">
                        <strong>Criteria 5: Student Support and Progression</strong></a></p><br /><br />

                <p class="titleDescription"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
                        href="criteria6.php">
                        <strong>Criteria 6: Governance, Leadership and Management</strong></a></p><br /><br />
						 <p class="titleDescription"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
                        href="criteria7.php">
                        <strong>Criteria 7: Institutional Values and Best Practices</strong></a></p><br /><br />
						 <p class="titleDescription"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
                        href="https://rkdf.ac.in/Feedback_Analysis.php">
                        <strong>Feedback Policy</strong></a></p><br /><br />
