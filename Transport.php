...
<section id="contentLeft">
	...
	<h2 class="titleDescription"><a class="menuitem" href="Transport.php"><span>&nbsp;</span> Transport </a></h2>
	<p class="titleDescription">&nbsp;</p>
	<p class="titleDescription"><img src="images/img/clg7-1326454137.jpg" width="604" height="453" /></p>
	<p class="titleDescription">&nbsp; </p>
	<p class="titleDescription">&nbsp;</p>
	<p class="titleDescription">&nbsp;</p>
	<p class="titleDescription">&nbsp;</p><br /><br />
		<p class="titleDescription style1"><a href="images/06/BUS_ROUTES_AND_TIMINGS.pdf" target="_blank"><strong>BUS ROUTES AND TIMING 2016</strong></a></p>
		<p>The University runs a fleet of buses to help students and staff members commute to and fro from areas around the city. </p>
	<p>&nbsp;</p>
	</div>
                <p>&nbsp;</p>
                <p>&nbsp;</p>
