...
<h2 class="titleDescription"><a href=""> Master of Technology ( M.Tech) Syllabus</a></h2>
                  ...
                  <li class="style9">
                    <table width="200" border="1">
                      ...
                      <tr>
                        ...
                        1st  to 2nd Year ( 1st to 4th SEM ALL ) </span></td>
                        <td width="167">&nbsp;</td>
                        <td width="73">&nbsp;</td>
                      </tr>
                      <tr>
                        <td colspan="2"><a href="syllabus/Technical syllabus/M.Tech/M.Tech. Computer Science & Engg.pdf" target="_blank"><strong>M.Tech ( Computer Sc. and Engg. )</strong></a></td>
                        <td>&nbsp;</td>
                      </tr>
                      <tr>
                        <td colspan="2"><a href="syllabus/Technical syllabus/M.Tech/M.Tech. Digital Communication.pdf" target="_blank"><strong>M.Tech ( 	Digital Communication )</strong></a></td>
                        <td>&nbsp;</td>
                      </tr>
                      <tr>
                        <td colspan="2"><a href="syllabus/Technical syllabus/M.Tech/M.Tech. Power Electronics.pdf" target="_blank"><strong>M.Tech (Power Electronics  )</strong></a></td>
                        <td>&nbsp;</td>
                      </tr>
					  
                      <tr>
                        <td colspan="2"><a href="syllabus/Technical syllabus/M.Tech/M.Tech. Power System.pdf" target="_blank"><strong>M.Tech ( Power System  )</strong></a></td>
                        <td>&nbsp;</td>
                      </tr>
                      <tr>
                        <td colspan="2"><a href="syllabus/Technical syllabus/M.Tech/M.Tech. VLSI.pdf" target="_blank"><strong>M.Tech ( VLSI Design. )</strong></a></td>
                        <td>&nbsp;</td>
                      </tr>
					  <tr>
                        <td colspan="2"><a href="syllabus/Technical syllabus/M.Tech/M.Tech Thremal.pdf" target="_blank"><strong>M.Tech ( Thermal)</strong></a></td>
                        <td>&nbsp;</td>
                      </tr>
					   <tr>
                        <td colspan="2"><a href="syllabus/Technical syllabus/M.Tech/M.Tech_PI.pdf" target="_blank"><strong>M.Tech ( Production & Industrie(PI) )</strong></a></td>
                        <td>&nbsp;</td>
                      </tr>
					  <tr>
                        <td colspan="2">&nbsp;</td>
