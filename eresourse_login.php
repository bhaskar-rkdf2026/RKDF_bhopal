...
<head>
<meta charset="UTF-8" />
<title>RKDF UNIVERSITY | LIBRARY E-RESOURCE LOGIN </title>
...
<section id="contentLeft">
  ...
  <span class="style13">LIBRARY &nbsp;  E-RESOURCE LOGIN  </span>
	<blockquote>
	  <p class="style14">&nbsp;</p>
	</blockquote>
	 ...
	 <table width="653" height="262" border="0"  bgcolor="#DCEDED">
       ...
       <tr>
         ...
         <td width="250"><span class="style14">ENTER YOUR ENROLLMENT NO. </span></td>
         <td width="376"><input type="text" name="rollno" required oninput="this.value = this.value.toUpperCase()" title="ENTER YOUR ENROLLMENT NO."   /></td>
       </tr>
      <tr>
         <td height="70">&nbsp;</td>
         <td><span class="style14">TODAY'S DATE</span></td>
         <td><input type="label" name="date"  title="TODAY'S DATE AUTO SUBMIT" value="<?php echo $date; ?>"></td>
       </tr>
       <tr>
         <td height="72">&nbsp;</td>
         <td>&nbsp;</td>
