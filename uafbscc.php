...
<section id="contentLeft">
	<div id="collegeDetail">
        <h2 class="titleDescription"><a href="uafbscc.php"><span>&nbsp;</span>Universities Approved For Bihar Student Credit Card</a></h2>

		<!-- New content added on 27-July-2024 on request by Mr. Virendra Patel -->
		<p style="padding-top: 30px;">
            <h1 style="padding-top:12px;padding-bottom:12px;color: navy;font-size: 23px;font-weight: 600;" >
				Universities Approved For Bihar Student Credit Card</h1>
                <ul>
                    <li>
                        <br><h2><a href="https://www.7nishchay-yuvaupmission.bihar.gov.in/listofcollegedetail" target="_blank" 
                            style="font-size: 15px;color: navy;padding-top: 12px;padding-bottom: 30px;">
                            <img src="/images/bullet.png" style="width: 16px;height: 16px;vertical-align: middle;">
                            Approved List of College for BSCC - शिक्षा विभाग, योजना एवं विकास विभाग एवं श्रम संसाधन विभाग, बिहार सरकार - MNSSBY</a></h2><br><br>
                    </li>
                    <li>
                        <br><h2><a href="Universities_Approved_For_Bhiar_Student_Credit_Card.pdf" target="_blank" 
                            style="font-size: 15px;color: navy;padding-top: 12px;padding-bottom: 30px;">
                            <img src="/images/bullet.png" style="width: 16px;height: 16px;vertical-align: middle;">
                            Approved List of College for BSCC - शिक्षा विभाग, योजना एवं विकास विभाग एवं श्रम संसाधन विभाग, बिहार सरकार - MNSSBY</a></h2><br><br>
                    </li>
