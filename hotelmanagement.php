...
<section id="contentLeft">
	...
	<h2 class="titleDescription"><a href="Education.php"> Faculty of Hotel Management </a></h2>
	...
	<blockquote>
      ...
      <tr bgcolor="#9A9A4E">
        <td colspan="3"><span class="style1">Hotel Management</span></td>
        <td width="308">&nbsp;</td>
      </tr>
       <tr>
        <td width="135">&nbsp;</td>
	   ...
	   <tr>
        <td width="135"><strong>DIPLOMA </strong></td>
        <td width="116">&nbsp;</td>
        <td width="81">&nbsp;</td>
        <td width="308" rowspan="2">&nbsp;</td>
      </tr>
	  <tr>
        <td width="135"><strong>DEGREE</strong></td>
        <td width="116">&nbsp;</td>
        <td width="81">&nbsp;</td>
        </tr>
    </table>
