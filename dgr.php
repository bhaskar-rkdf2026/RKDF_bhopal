...
$heroSubtitle = !empty($pRow['hero_subtitle']) ? $pRow['hero_subtitle'] : 'Spearheading R&D grants, patent filing, doctoral research oversight, and international publications.';
$introText    = !empty($pRow['intro_text'])    ? $pRow['intro_text']    : 'The DGR office supports faculty and doctoral scholars in securing national research grants (DST, AICTE, ISRO) and commercializing inventions.';
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <style>
    ...
    .dgr-block-card { background: #ffffff; border: 1px solid rgba(12,20,36,0.08); border-radius: 20px; overflow: hidden; box-shadow: 0 4px 24px rgba(12,20,36,0.04); margin-bottom: 36px; }
    ...
    .dgr-card-title { font-family: 'Playfair Display', Georgia, serif; font-size: 24px; font-weight: 700; color: #ffffff; margin: 0; }
      ...
      <div class="dgr-grid-layout">
        ...
        <div>
          <article class="dgr-block-card">
            <div class="dgr-card-header">
              <h2 class="dgr-card-title">DGR Profile &amp; Research Desk</h2>
              <span style="background:rgba(197,160,89,0.18);color:#C5A059;padding:4px 12px;border-radius:99px;font-size:11px;font-weight:700;">DGR OFFICE</span>
            </div>
        ...
        <aside>
          <div class="sidebar-card">
            <h3 class="sidebar-title">Research Leadership</h3>
