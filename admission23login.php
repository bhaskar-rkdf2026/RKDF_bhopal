...
<table width="901" border="0"  cellspacing="2"  cellpadding="6" bgcolor="#FFFFD2">
  ...
  <tr>
	...
	<table width="822" border="0">
      <tr bgcolor="#FFCF9F">
        <td width="173"><a href="admission23login.php" class="style2"><strong>Home</strong></a></td>
        <td width="192"></td>
        <td width="219"></td>
  ...
  <tr>
	...
	{
	?>
    <p>&nbsp; <a href="admission23data.php" class="style2" target="_blank">Admission Enquiry 2023</a> </p>
	<?php
	}
	...
	<div align="center">
	  ...
	  if (isset($_SESSION["user"]))
	  {
	  echo "Welcome ".$_SESSION["user"]."! <a href='logout23.php'>Logout</a>";
	  }
	...
	<form method="post" action="hmlogin23.php">
