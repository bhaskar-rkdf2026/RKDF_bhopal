...
<head>
    ...
    <meta name="keywords"
        content="Best university in bhopal,rkdf paramedical, paramedical,rkdf university paramedical " />
    ...
    <section id="content" class="wrapper ">
        ...
        <section id="contentLeft">
            <div id="collegeDetail">
                <h2 class="titleDescription"><a href="#">Faculty of Paramedical.</a></h2>
                <p class="titleDescription">&nbsp;</p>
                <blockquote>

                    <table width="1122" height="265" border="1" cellpadding="0" cellspacing="0">
                       <tr>
          <td colspan="6"><a href="https://rkdf.ac.in/approval/paramedical%202022-23.pdf" target="_blank" > <span class="style8"> ( MP PARAMEDICAL APPROVED ) </span> </a></td>
        </tr>
                        <tr bgcolor="#9A9A4E">
                            <td width="367" height="43"><span class="style1">Courses</span></td>
                            <td width="56"><span class="style1">Year</span></td>
                            <td width="44"><span class="style1">Seats</span></td>
                            <td width="173"><span class="style1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Eligibility</span>                            </td>
                        </tr>
                        <tr>
                            <td width="367" height="40"><span class="style6">BACHELOR OF PHYSIOTHERAPY(BPT)</span></td>
                            <td width="56"><span class="style6"> 4&frac12; Years </span></td>
                            <td width="44"><span class="style6">50</span></td>
                            <td width="173" rowspan="6" class="style6">Passed 10+2 in Science(PCB) with min 50% marks for unreserved category & 40% for reserved category candidate</td>
                        </tr>
                        <tr>
                           <td width="367" height="40"><span class="style6">BACHELOR OF MEDICAL LAB TECHNICIAN(BMLT)</span></td>
                            <td width="56"><span class="style6">3 Years</span></td>
                            <td width="44"><span class="style6">50</span></td>
                        </tr>
                        <tr>
                            <td width="367" height="40"><span class="style6">DIPLOMA IN MEDICAL LAB TECHNICIAN(DMLT)</span></td>
                            <td width="56"><span class="style6">2 Years</span></td>
                            <td width="44"><span class="style6">50</span></td>
                        </tr>
                        <tr>
                             <td width="367" height="40"><span class="style6">DIPLOMA IN X-RAY RADIOGRAPHER TECHNICIAN</span></td>
                            <td width="56"><span class="style6">2 Years</span></td>
                            <td width="44"><span class="style6">50</span></td>
                        </tr>

                        <tr>
                            <td width="367" height="40"><span class="style6">DIPLOMA IN PHARMACY (HOMOEOPATHY)</span></td>
                            <td width="56"><span class="style6">2 Years</span></td>
                            <td width="44"><span class="style6">50</span></td>
                        </tr>
