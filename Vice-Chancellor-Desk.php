...
<head>
    ...
    <meta name="keywords"
        content="Best university in bhopal,rkdf university, Vice-Chancellor Desk " />
...
.style4 {color: #000000;
font-size:16px;}
.style5 {color: #000000; line-height: 1.5; font-family: Arial, Helvetica, sans-serif; font-size:13px }
</style>
</head>
	<body>
...
<section id="contentLeft">
	...
	<p  class="titleDescription"><img src="images/img/VC Sir Pic.jpg"  /> <span class="vc">Prof. Vijay K. Agrawal</span> <br />
	&nbsp;<span class="vc2">M.Sc., D.Phil., PGD (Chem. & Chem. Engg.)	</span><br />
	&nbsp;<span class="vc2">Tokyo Institute of Technology, Japan	</span><br />
	<span class="style1">&nbsp;Vice-Chancellor</span></p>
	<p  class="titleDescription"><span class="style1">&nbsp;Contact Details: 
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />&nbsp;&nbsp;Email: vc@rkdf.ac.in</span></p>
	
	<p>&nbsp;</p><p>&nbsp;</p>
	<p class="titleDescription"> <span class="style2">
	<u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&quot;MESSAGE&quot;</u>
	</span></p>
	<p class="style5">Heartiest Greetings from RKDF University, Bhopal!!</p>
	<p align="justify" class="style5">Higher education in the country is at the threshold of major institutional reforms targeted towards cutting edge R&D and innovations. The major challenges before the upcoming and emerging Universities apart from quality of teaching and learning process are the need of experienced and enlightened faculty. Network of knowledge management, creative teaching and research, strong industry interface and innovative curriculum are the need of the day. Apart from this the Nation is moving forward by implementing NEP2020. <br />
	  <br />
	...
	<p align="justify" class="style5">We, the RKDF Faculty Members and the Staff along with Our Learned Management are committed to build this University a real knowledge hub and, to work towards shaping the top class career of our students. We are moving ahead to help the villages through our extension programs. For this our resources have been mobilized for strengthening the youth & woman of the nearby village.</p>
	
	<p align="justify" class="style5">We do welcome your suggestions and feedback if we can work together for further improvement, in turn, enabling us to continue imparting world class education. </p>
	<p align="justify" class="style5" > With Best Wishes for Ever to Our Students! </p>
	</div>
                <p align="center"><u><a href="VC Portfolio.pdf" target="_blank"><span class="style3">"BRIEF INTRODUCTION"</span></a></u></p>
                <p>&nbsp;</p>
                <p>&nbsp;</p>
                <p>&nbsp;</p>
                <p>&nbsp;</p>
