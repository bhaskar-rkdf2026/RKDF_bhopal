...
<table width="1000" height="207" border="0" bgcolor="#EAF1E2">
  ...
  <tr>
    ...
    <div align="center" class="style5"><u>ONLINE GRIEVANCE REDRESSAL FORM : </u> </div></td>
  </tr>
</table>
  <form method="post" action="email_form.php" >
  <table width="1000" border="0" bgcolor="#FFFFD2">
  <tr>
    <td width="220" height="82">&nbsp;</td>
    <td colspan="3">&nbsp;<strong>Redressal of all types of Grievances, Complaints and Malpractices received from Individuals,<br />
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Institutions, Government and Statutory & Professional bodies.</strong></td>
    </tr>
  <tr>
    <td width="220">&nbsp;</td>
    <td width="225">&nbsp;</td>
  ...
  <tr>
    ...
    <td><input type="text" name="first_name"  placeholder="Full name"/>	        </td>
  </tr>
  <tr>
    <td height="25">&nbsp;</td>
    ...
    <td><span class="style7">:</span></td>
    <td><input type="text" name="fnm" placeholder="Father's name" />     </td>
  </tr>
  ...
  <tr>
    ...
    <td><span class="style7">:</span></td>
    <td><input type="text" name="telephone" placeholder="Mobile no." />      </td>
  </tr>
  <tr>
    <td height="25">&nbsp;</td>
    <td><div align="right" class="style9">
      <div align="left">COLLEGE NAME </div>
    </div></td>
    <td><span class="style7">:</span></td>
    <td><input type="text" name="last_name" placeholder="Enter your college name" />     </td>
  </tr>
   <tr>
    <td height="30">&nbsp;</td>
    <td><div align="right" class="style9">
  ...
  <tr>
    ...
    <td><span class="style7">:</span></td>
    <td><input type="text" name="add" placeholder="Complaint subject " ></td>
  </tr>
  <tr>
    <td height="55">&nbsp;</td>
    <td><div align="right" class="style9">
    ...
    <td><span class="style7">:</span></td>
    <td><textarea name="comments" rows="5" cols="30" placeholder="Write here your complaint"></textarea></td>
  </tr>
  <!--<tr>
    <td height="30">&nbsp;</td>
    <td><div align="right" class="style9">
