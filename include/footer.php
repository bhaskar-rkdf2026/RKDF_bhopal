  ...
  <div class="rk-container">
    ...
    <div class="rk-footer-top">
      ...
      <div class="rk-footer-brand">
        ...
        <div class="rk-footer-social">
          <a href="https://facebook.com" target="_blank" rel="noopener" class="rk-footer-social-link" aria-label="Facebook">
          ...
          <a href="https://twitter.com" target="_blank" rel="noopener" class="rk-footer-social-link" aria-label="Twitter/X">
          ...
          <a href="https://instagram.com" target="_blank" rel="noopener" class="rk-footer-social-link" aria-label="Instagram">
          ...
          <a href="https://linkedin.com" target="_blank" rel="noopener" class="rk-footer-social-link" aria-label="LinkedIn">
          ...
          <a href="https://youtube.com" target="_blank" rel="noopener" class="rk-footer-social-link" aria-label="YouTube">
      ...
      <div>
        ...
        <ul class="rk-footer-col-links">
          ...
          <li><a href="Contact_us.php">Alumni</a></li>
          <li><a href="Contact_us.php">Emergency</a></li>
        </ul>
      </div>
    </div><!-- /rk-footer-top -->
    ...
    <div class="rk-footer-bottom">
      ...
      <div class="rk-footer-legal">
        ...
        <a href="Contact_us.php">Accessibility</a>
