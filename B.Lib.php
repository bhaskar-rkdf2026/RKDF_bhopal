...
<section id="contentLeft">
	...
	<h2 class="titleDescription"><a href="Education.php"> Faculty of Library Science</a></h2>
	<blockquote>
      ...
      <tr bgcolor="#9A9A4E">
       ...
       <tr>
        <td width="135"><span class="style6"> B.Lib</span></td>
        <td width="116"><span class="style6">1 years</span></td>
        <td width="81"><span class="style6">60</span></td>
        <td width="308"><span class="style6">Any Graduate passed</span></td>
      </tr>
	   <tr>
        <td width="135"><span class="style6"> M.Lib</span></td>
        <td width="116"><span class="style6">1 years</span></td>
        <td width="81"><span class="style6">60</span></td>
        <td width="308"><span class="style6">B. Lib passed</span></td>
      </tr>
