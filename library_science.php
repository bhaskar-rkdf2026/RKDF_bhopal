...
<section id="contentLeft">
	...
	<h2 class="titleDescription"><a href="#"> Faculty of Library & Information Science <br/>
	</a></h2>
	
	<table width="1122" height="172" border="1" cellpadding="0" cellspacing="0">
	  <tr>
          <td height="16" colspan="6"></td>
        </tr>	
      <tr bgcolor="#9A9A4E">
        <td width="349" height="26"><span class="style1">Courses</span></td>
        <td width="51"><span class="style1">Year</span></td>
        <td width="45"><span class="style1">Seats</span></td>
        <td width="195"><span class="style1">Eligibility</span></td>
      </tr>
       <tr>
        <td width="349" height="60"><span class="style6">Bachelor of Library & Information Science (B.LIB & I.Sc)</span></td>
        <td width="51"><span class="style6">1 Year</span></td>
        <td width="45"><span class="style6">40</span></td>
        <td width="195" class="style6">Any Passed Graduate with 50% and 45% in Case of Reserve Category.</td>
       </tr>
<tr>
        <td width="349" height="68"><span class="style6">Master of Library & Information Science (M.LIB & I.Sc)</span></td>
        <td width="51"><span class="style6">1 Year</span></td>
        <td width="45"><span class="style6">40</span></td>
        <td width="195" class="style6">Passed B.LIB with 50%.</td>
</tr>
