     ...
     <section id="content" class="wrapper ">
         ...
         <section id="contentLeft">
             <div id="collegeDetail">
                 <h2 class="titleDescription"><a href=""
                         style="font-size: larger;font-weight: 600;font-family: sans-serif;"><span>&nbsp;</span>AICTE
                         Approval 2025-26</a></h2>
         ...
         <div id="collegeDetail2627">
             <h2 class="titleDescription">
                 <label style="font-size: larger;font-weight: 600;font-family: sans-serif;">AICTE Approval
                     2026-27</label>
             </h2>
         ...
         <div id="collegeDetail262701" style="padding-bottom:50px;">
             <p style="padding-top: 8px;padding-bottom: 8px;">
                 <a href="approval\AICTE_26-27\IPE EOA Report 2026-2027.PDF" target="_blank" style="padding-left:20px">
                     <strong> &nbsp;&nbsp;&nbsp;IPE - Extension approval for the academic (EoA) 2026-27</strong>
                 </a>
             </p>

             <p style="padding-top: 10px;padding-bottom: 10px;">
                 <a href="approval/AICTE_26-27/VIT_EOA Report 2026-2027.pdf" target="_blank" style="padding-left:20px">
                     <strong> &nbsp;&nbsp;&nbsp;VIT - Extension approval for the academic (EoA) 2026-27</strong>
                 </a>
             </p>

             <p style="padding-top: 10px;padding-bottom: 10px;">
                 <a href="approval/AICTE_26-27/AGNOS EOA Report 2026-2027.PDF" target="_blank" style="padding-left:20px">
                     <strong> &nbsp;&nbsp;&nbsp;AGNOS - EOA Report (EoA) 2026-27</strong>
                 </a>
             </p>

             <p style="padding-top: 10px;padding-bottom: 10px;">
                 <a href="approval/AICTE_26-27/BCE EOA Report 26-27.pdf" target="_blank" style="padding-left:20px">
                     <strong> &nbsp;&nbsp;&nbsp;BCE - EOA Report (EoA) 2026-27</strong>
                 </a>
             </p>

             <p style="padding-top: 10px;padding-bottom: 10px;">
                 <a href="approval/AICTE_26-27/RKDFCTR EOA Report 2026-2027.PDF" target="_blank" style="padding-left:20px">
                     <strong> &nbsp;&nbsp;&nbsp;RKDFCTR - EOA Report (EoA) 2026-27</strong>
                 </a>
             </p>

             <p style="padding-top: 10px;padding-bottom: 18px;">
                 <a href="approval/AICTE_26-27/SSSCE EOA Report 26-27.PDF" target="_blank" style="padding-left:20px">
                     <strong> &nbsp;&nbsp;&nbsp;SSSCE - EOA Report (EoA) 2026-27</strong>
                 </a>
             </p>
