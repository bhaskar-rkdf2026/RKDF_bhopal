...
<section id="contentLeft">
	...
	<h2 class="titleDescription"><a href="https://rkdf.ac.in/homoeopathy/" target="_blank"><font color="#6C006C"> RAM KRISHNA COLLEGE OF HOMOEOPATHY & MEDICAL SCIENCES,RKDF UNIVERSITY </font><br/>
	</a></h2>
	
	<table width="1122" height="153" border="1" cellpadding="0" cellspacing="0">
	  <tr>
          <td colspan="6"><a href="https://rkdf.ac.in/approval/BHMS_2022.pdf" target="_blank" > <span class="style8"> ( CCH APPROVED ) </span> </a></td>
        </tr>	
      <tr bgcolor="#9A9A4E">
        <td width="188" height="36"><span class="style1">Courses</span></td>
        <td width="80"><span class="style1">Years</span></td>
        <td width="91"><span class="style1">Seats</span></td>
        <td width="281"><span class="style1">Eligibility</span></td>
      </tr>
       <tr>
        <td width="188" height="31"><span class="style6">B.H.M.S.</span></td>
        <td width="80"><span class="style6">4.5 Years </span></td>
        <td width="91"><span class="style6">100
</span></td>
        <td width="281" class="style6">Passed in 10+2 or equivalent examination in science with PCB and English as compulsory subjects with at least 50% and must have minimum age of 17 yrs. </td>
      </tr>
    </table>
	<p>&nbsp;</p>
	<p align="justify"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
