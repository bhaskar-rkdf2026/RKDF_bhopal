...
<meta name="description" content=" rkdf,rkdf university, web developer prashant pare,prashant pare,developer">
...
<section id="contentLeft">
	...
	<h2 class="titleDescription"><a href="Vision.php"><span>&nbsp;</span>Developed By:- </a></h2>
	<p class="titleDescription"><img src="images/img/developer.jpg" width="171" height="150" /></p>
	<p class="titleDescription">&nbsp;</p>
	<p class="titleDescription style6 style7">PRASHANT PAREY </p>
	<p class="titleDescription style6">SOFTWARE DEVELOPER RKDF GROUP  </p>
	<p class="style6">Mob:- +91-9755670668 , 8319215763. </p>
	<p class="style6">Email:- prashant@rkdf.ac.in </p>
	<p class="style6">&nbsp;</p>
	<p class="titleDescription style6 style7" >&nbsp;</p>
	<p class="titleDescription ">&nbsp;</p>
	</div>
                <p>&nbsp;</p>
                <p>&nbsp;</p>
