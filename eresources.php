...
<section id="contentLeft">
	...
	<h2 class="titleDescription"><a href="eresource.php"><span>&nbsp;</span>E-Resources</a></h2>
	<p class="titleDescription">&nbsp;</p>
	<p class="titleDescription"><img src="images/img/e-resources.jpg" width="313" height="171" /></p>
	<p class="titleDescription">&nbsp;</p>
	<p class="titleDescription">&nbsp;</p>
	<p class="titleDescription">&nbsp;</p>
	<p class="titleDescription">&nbsp;</p>
	<p class="titleDescription">&nbsp;</p>
	<p align="justify">“E-learning comprises all forms of electronically-supported  learning and teaching.  The information and communication systems, whether networked or  not, serve as specific media to implement the learning process.  Content is delivered via the Internet, intranet/extranet, audio or video tape, satellite TV, USB and CD/DVD-ROM. It can be self-paced or instructor-led and includes media in the form of text, image, animation, streaming video and audio.<br />
