...
<section id="contentLeft">
	...
	<h2 class="titleDescription"><a href="Academic-Celendar.php"><span>&nbsp;</span> Academic Calendar </a></h2>
	<p class="titleDescription">&nbsp;</p>
	<h2 class="style6"> <strong><em><a href="http://www.rkdf.ac.in/index.php?option=com_phocadownload&amp;view=category&amp;id=37&amp;Itemid=252"><img src="images/img/pageunder.jpg" width="245" height="206" /></a></em></strong></h2>
	</div>
			...
			<section id="sideBar">
			  <aside id="customMenu" class="sidebarWidget">
			    ...
			    <div class="glossymenu"> <a class="menuitem" href="Rules-For-Faculty.php"><img src="images/bullet.png" /> Rules For Faculty </a> 
				...
				<a class="menuitem" href="Courses-And-Programs.php"><img src="images/bullet.png" />Courses And Programs</a>
				 <a class="menuitem" href="Academic-Celendar.php"><img src="images/bullet.png" /> Academic Calendar </a>
