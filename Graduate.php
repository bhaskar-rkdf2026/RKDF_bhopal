...
<section id="contentLeft">
	...
	<h2 class="titleDescription"><a href="Graduate.php""><span>&nbsp;</span> Graduate (Bachelor) courses : </a></h2>
	...
	<p>- Engineering (BE). </p>
	<p>- Pharmacy (B.Pharm).</p>
	<p>- Business Administration (BBA).</p>
	<p>- Education (B.Ed).</p>
	<p>- Commerce (B.Com).</p>
	<p>- Science (B.Sc).</p>
	<p>- Computer Application (BCA).</p>
	<p>- Library Science (B.Lib).</p>
	<p>-Optometry (B.Sc. Opto).</p>
	<p>- Arts (BA).</p>
	<p>-L.L.B.</p>
	<p>-B.A.L.L.B</p>
	<p>&nbsp; </p>
...
<a class="menuitem" href="Gratuate.php"><img src="images/bullet.png" />Graduate</a>
