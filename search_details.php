...
$con=mysql_connect($host,$user,$pass);
	   ...
	   //$regid=$_SESSION['rid'];
		//$mob=$_SESSION['rmob'];
		//$qry="SELECT ID FROM posts WHERE username LIKE %$search% OR subject LIKE %$search% OR content LIKE %$search%;";	

//$qry=" select * from pay where id like '%".$regid1."%' or order_id like '%".$orderid1."%' or name like '%".$name."%' or mob like '%".$mobile1."%' or ref like '%".$ref1."%'";

$qry=" select * from pay where id='".$regid."'";
