    ...
    <div class="rk-container">
      <div class="govb-grid-layout">
        ...
        <div>
          ...
          <!-- STATUTORY ROLES CARD -->
          <article class="govb-block-card">
            <div class="govb-card-header">
              <h2 class="govb-card-title">Statutory Roles &amp; Responsibilities</h2>
              <span class="govb-badge">APEX POWERS</span>
            </div>
        ...
        <aside>
          <div class="sidebar-card">
            ...
            <ul class="sidebar-nav-list">
              ...
              <li><a href="Governingbody.php" class="sidebar-link active">Governing Body <span>→</span></a></li>
