                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th>Name</th>
                            <th>Designation</th>
                            <th>Qualification/Discipline</th>
                            <th>Photo</th>
                        ...
                        <?php else: ?>
                            <?php foreach ($staffData as $member): ?>
                                <tr>
                                    ...
                                    <td><?php echo ucwords(strtolower(htmlspecialchars($member['name']))); ?></td>
                                    <td><?php echo ucwords(strtolower(htmlspecialchars($member['designation']))); ?></td>
                                    <td><?php echo ucwords(strtolower(htmlspecialchars($member['subject_discipline']))); ?></td>
                                    <td>
                                        <?php if (!empty($member['photo_url'])): ?>
                                            <img src="images/Staff_Photos/<?php echo htmlspecialchars($member['photo_url']); ?>" alt="Photo of <?php echo htmlspecialchars($member['name']); ?>" class="staff-photo">
                                        <?php else: ?>
                                            N/A
                                        <?php endif; ?>
                                    </td>
