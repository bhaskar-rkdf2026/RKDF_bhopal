...
<h2 class="titleDescription"><a href="#"> PHARMACY Syllabus</a></h2>
                  ...
                  <li class="style9">
                    <table width="200" border="1">
                      <tr>
                        ...
                        DIPLOMA PHARMACY (1st to 2nd Year )</span></td>
                        <td width="167">&nbsp;</td>
                        <td width="73">&nbsp;</td>
                      </tr>
                      <tr>
                        <td colspan="3"><a href="syllabus/Technical syllabus/Pharmacy/D.Pharma Syllabus.pdf" target="_blank"><strong> &nbsp;  D.Pharma  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </strong></a></td>
                      </tr>
                      <tr>
                        <td width="388"><span class="style3"><br />
                        BECHLOR OF PHARMACY ( 1st to 8th SEM ALL ) </span></td>
                        <td width="167">&nbsp;</td>
                        <td width="73">&nbsp;</td>
                      </tr>
					   <tr>
                        <td colspan="3"><a href="syllabus/Technical syllabus/Pharmacy/B.Pharm Syllabus OLD.pdf" target="_blank"><strong> &nbsp;  B.Pharma (OLD)  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </strong></a></td>
                      </tr>
					  <tr>
                        <td colspan="3"><a href="syllabus/Technical syllabus/Pharmacy/B.Pharm Syllabus NEW.pdf" target="_blank"><strong> &nbsp;  B.Pharma (New Syllabus as per PCI) &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </strong></a></td>
                      </tr>
					   <tr>
                        <td width="388"><span class="style3"><br />
                        MASTER OF PHARMACY ( 1st to 4th SEM ALL ) </span></td>
                        <td width="167">&nbsp;</td>
                        <td width="73">&nbsp;</td>
                      </tr>
                      <tr>
                        <td colspan="2"><a href="syllabus/Technical syllabus/Pharmacy/M_Pharm PCI.pdf" target="_blank"><strong>&nbsp;  M.Pharma  (New Syllabus as per PCI)</strong></a></td>
                        <td>&nbsp;</td>
                      </tr>
                      <tr>
                        <td colspan="2">&nbsp;</td>
