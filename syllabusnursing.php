...
<h2 class="titleDescription"><a href="">  (NURSING ) Syllabus</a></h2>
                ...
                <ul>
                  <li class="style9">
                    <table width="200" border="1">
                      ...
                      B.SC. NURSING  ( ALL   ) </span></td>
                        <td width="167">&nbsp;</td>
                        <td width="73">&nbsp;</td>
                      </tr>
                      <tr>
                        <td height="38" colspan="2"><a href="syllabus/B.Sc. Nursing New Syllabus.pdf" target="_blank"><strong> NURSING NEW SCHEME (B.SC. NURSING) &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong></a></td>
                        <td>&nbsp;</td>
                      </tr>
					    <tr>
                        <td colspan="2"><a href="syllabus/B.Sc. Nursing.pdf" target="_blank"><strong> NURSING OLD SCHEME (  B.SC. NURSING) &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong></a></td>
                        <td>&nbsp;</td>
                      </tr>
					  <tr>
                        <td width="388"><span class="style3"><br />
                      POST BASIC BSC NURSING</span></td>
                        <td width="167">&nbsp;</td>
                        <td width="73">&nbsp;</td>
                      </tr>
                      <tr>
                        <td colspan="2"><a href="syllabus/POST BASIC BSC NURSING.pdf" target="_blank"><strong> NURSING (POST BASIC BSC NURSING) &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong></a></td>
                        <td>&nbsp;</td>
                      </tr>
					  <tr>
                        <td width="388"><span class="style3"><br />
                       GNM NURISNG (  ALL ) </span></td>
                        <td width="167">&nbsp;</td>
                        <td width="73">&nbsp;</td>
                      </tr>
                      <tr>
                        <td colspan="2"><a href="syllabus/GNM NURISNG.pdf" target="_blank"><strong> NURISNG( GNM NURISNG) &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong></a></td>
                        <td>&nbsp;</td>
                      </tr>
					  <tr>
                        <td colspan="2">&nbsp;</td>
