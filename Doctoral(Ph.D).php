...
<section id="contentLeft">
	...
	<h2 class="titleDescription"><a href="Doctoral(Ph.D).php""><span>&nbsp;</span> Doctoral(Ph.D) </a></h2>
	
	
	<p class="style6"><img src="images/img/doct.jpg" width="225" height="225" /></p>
	
	
	
	<p class="style6">&nbsp;</p>
	<p class="style6">-Engineering &amp; Technology.</p>
	<p class="style6">-Pharmacy.</p>
	<p class="style6">-Management.</p>
	<p class="style6">-Apllied Science.</p>
	<p class="style6">-Computer Application.</p>
	<p class="style6">-Commerce.</p>
	<p class="style6">-Humanities &amp; Languages.</p>
	<p class="style6">-Education.</p>
	<p class="style6">-Library Science.</p>
	<p class="style6">-Arts.</p>
	<p class="style6">-Biotechnology.</p>
	<p class="style6">-Genetics.      </p>
				</div>
...
<a class="menuitem" href="Post-Gratuate.php"><img src="images/bullet.png" /> Post Gratuate </a>
