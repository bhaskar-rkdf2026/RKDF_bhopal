        ...
        <section id="contentLeft">
            <div id="collegeDetail" style="min-height: 2px !important;">
                <h2 class="titleDescription">
                    <a href="#" class="style4"><font color="#FF1111">Library - RKDF University</font> </a> 
                </h2>
            </div>

            <h2 class=""> <strong><em><a href="#"></a></em></strong><img src="images/img/library.jfif" /><br/><br/></h2>
            <!-- <p>
            ...
            <p>
                <label><strong><h2>Library Details</h2></strong></label></p><p>&nbsp;<br/><br/>
            </p>
            <p>
                <label style="line-height: 1.6;"><strong>Librarian Name&#58; - Dr. </strong></label><br/><br/>
                <label style="line-height: 1.6;"><strong>Area&#58; - </strong></label><br/><br/>
                <label style="line-height: 1.6;"><strong>Books Count&#58; - </strong></label><br/><br/>
                <label style="line-height: 1.6;"><strong>No of Titles&#58; - </strong></label><br/><br/>
            </p>
