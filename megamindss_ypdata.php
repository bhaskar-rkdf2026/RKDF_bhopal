...
<head>
  ...
  <title>FACULTY OF LAW || MEGAMINDSS 2K18 — RKDF University Bhopal</title>
...
<body>
  ...
  <section class="subpage-hero">
    <div class="rk-container">
      ...
      <h1 class="rk-h1" style="font-size:clamp(2.5rem, 5.5vw, 5.2rem);margin-top:12px;">FACULTY OF LAW || MEGAMINDSS 2K18</h1>
    </div>
  </section>
