    ...
    <section id="content" class="wrapper ">
        ...
        <section id="contentLeft">
            <div id="collegeDetail">
                <h2 class="titleDescription"><a href="#"> FACULTY OF ARCHITECTURE </a></h2>
                <p class="titleDescription">&nbsp;</p>
                <blockquote>
                    <table width="1122" border="1" cellpadding="0" cellspacing="0">
                        <tr>
                            <td height="25" colspan="6"> </span><a href="https://rkdf.ac.in/approval/COA_2022-23.pdf" target="_blank" > <span class="style8">( COA & NATA CENTRE APPROVED )</span></a></span></td>
                        </tr>
                        <tr bgcolor="#9A9A4E">
                        ...
                        <tr>
                            <td width="135" rowspan="6"><span class="style6"> B.Arch. </span></td>
                            <td width="107" rowspan="6"><span class="style6">10 Sem</span></td>
                            <td width="78" rowspan="6"><span class="style6">30 </span></td>
                            <td width="320" rowspan="6" class="style6">
                                Qualified through recognized aptitude test in NATA or JEE and obtained 50% at least (45% for  reserved category) in 10+2.<br /><span class="style8">OR</span> <br />
 Equivalent examination & 50% aggregate in PCM also.<br />
 <span class="style8">OR</span> <br />
passed 10+3 Diploma examination with Mathematics subject with at least 50% (45% for reserved category).</td>
                        </tr>
                        <tr>
                            <!-- <td width="135">&nbsp;</td>
                            <td width="107">&nbsp;</td>
                        ...
                        <tr>
                            <td width="213" height="59" rowspan="2"><span class="style6">M.Arch. <br />
                            </span></td>
                            <td width="83"><span class="style6">2 Years </span></td>
                            <td width="63"><span class="style6">20</span></td>
                    <td width="281" class="style6">Passed B.Arch atleast 50% for UR category and 45% for Reserved category.</td>
                        </tr>
                    </table>
                    <p>&nbsp;</p>
                </blockquote>
