...
<section id="contentLeft">
	...
	<h2 class="titleDescription"><a href="vCampus.html"><span>&nbsp;</span> vCampus </a></h2>
	<p class="titleDescription">&nbsp;</p>
	<h2 class="style6"> <strong><em><a href="#"></a></em></strong><img src="images/img/vcampus.jpg" width="244" height="113" /></h2>
	<p class="style6">&nbsp;</p>
	<p class="style6">&nbsp;</p>
	<p class="style6">&nbsp;</p>
	<p class="style6">&nbsp;</p>
	<p class="style6">&nbsp;</p>
	<p class="style12"> VCampus, the leading e-Learning web portal for the rkdf group`s student , enables campus to offer online learning solutions to their faculty, students, employees around the world. </p>
	</div>
...
<a class="menuitem" href="vCampus.php"><img src="images/bullet.png" /> vCampus </a>
