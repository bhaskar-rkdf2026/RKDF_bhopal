...
<h2 class="titleDescription"><a href="#"> FACULTY OF ARCHITECTURE SYLLABUS</a></h2>
                  ...
                  <li class="style9">
                    <table width="200" border="1">
                      <tr>
                       ...
                       ARCHITECTURE (1 TO 10 SEM ALL)</span></td>
                        <td width="167">&nbsp;</td>
                        <td width="73">&nbsp;</td>
                      </tr>
                     <tr>
                        <td colspan="2"><a href="syllabus/architecture/FRONT_PAGES_OF_SYLLABUS.pdf" target="_blank"><strong> ARCHITECTURE FRONT PAGE</strong></a></td>
                        <td>&nbsp;</td>
                      </tr>
                      <tr>
                        <td colspan="2"><a href="syllabus/architecture/semester_1.pdf" target="_blank"><strong>ARCHITECTURE 1ST SEM</strong></a></td>
                        <td>&nbsp;</td>
                      </tr>
                     <tr>
                        <td colspan="2"><a href="syllabus/architecture/semester_2.pdf" target="_blank"><strong>ARCHITECTURE 2ND SEM</strong></a></td>
                        <td>&nbsp;</td>
                      </tr>
                      <tr>
                        <td colspan="2"><a href="syllabus/architecture/semester_3.pdf" target="_blank"><strong>ARCHITECTURE 3RD SEM</strong></a></td>
                        <td>&nbsp;</td>
                      </tr>
                      <tr>
                        <td colspan="2"><a href="syllabus/architecture/semester_4.pdf" target="_blank"><strong>ARCHITECTURE 4TH SEM</strong></a></td>
                        <td>&nbsp;</td>
                      </tr>
					 <tr>
                        <td colspan="2"><a href="syllabus/architecture/SEMESTER_5.pdf" target="_blank"><strong>ARCHITECTURE 5TH SEM</strong></a></td>
                        <td>&nbsp;</td>
                      </tr>
					  <tr>
                        <td colspan="2"><a href="syllabus/architecture/SEMESTER_6.pdf" target="_blank"><strong>ARCHITECTURE 6TH SEM</strong></a></td>
                        <td>&nbsp;</td>
                      </tr>
					  <tr>
                        <td colspan="2"><a href="syllabus/architecture/semester_7.pdf" target="_blank"><strong>ARCHITECTURE 7TH SEM</strong></a></td>
                        <td>&nbsp;</td>
                      </tr>
                       <tr>
                        <td colspan="2"><a href="syllabus/architecture/SEMESTER_8.pdf" target="_blank"><strong>ARCHITECTURE 8TH SEM</strong></a></td>
                        <td>&nbsp;</td>
                      </tr>
					   <tr>
                        <td colspan="2"><a href="syllabus/architecture/SEMESTER_9.pdf" target="_blank"><strong>ARCHITECTURE 9TH SEM</strong></a></td>
                        <td>&nbsp;</td>
                      </tr>
					  <tr>
                        <td colspan="2"><a href="syllabus/architecture/semester_10.pdf" target="_blank"><strong>ARCHITECTURE 10TH SEM</strong></a></td>
                        <td>&nbsp;</td>
                      </tr>
                    </table>
                    <p>&nbsp;</p>
