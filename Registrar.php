...
?>
    ...
    <section id="content" class="wrapper ">
        ...
        <section id="contentLeft">
            <div style="min-height: 180px;margin-bottom: 15px;float: left;width: 500px;">
                <h2 class="titleDescription"></h2>
                <p class="titleDescription">&nbsp;</p>
                <p class="titleDescription">
                    <img src="images/img/Dr SATENDRA SINGH THAKUR.jpeg"
                        style="height: 200px;padding-right: 30px;float: left;margin: 0px;width: auto;" /> <span
                        class="vc">Dr. Satendra S. Thakur</span>
                    <br />&nbsp;<span class="vc2">MBA, Ph.D. </span><br />
                <p>
                <p>
                    <span class="style1">&nbsp;Registrar</span>
                </p>
                <p class="titleDescription"><span class="style1">&nbsp;Contact Details: <br />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;+91 755-2740395 (Landline)<br />&nbsp;&nbsp;Email:
                        registrar@rkdf.ac.in</span></p>
                <p></p>
