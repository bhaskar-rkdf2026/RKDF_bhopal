...
$eyebrow      = !empty($pRow['eyebrow'])       ? $pRow['eyebrow']       : '11 · ADMINISTRATION';
$mainTitle    = !empty($pRow['page_title'])    ? $pRow['page_title']    : 'Registrar Profile';
$heroSubtitle = !empty($pRow['hero_subtitle']) ? $pRow['hero_subtitle'] : 'Custodian of university records, legal compliance, admissions, and academic secretariat.';
$introText    = !empty($pRow['intro_text'])    ? $pRow['intro_text']    : 'The Registrar ensures statutory compliance, statutory council reporting, enrollment verification, and university communication.';
...
$regTitle = !empty($allItems[0]['title']) ? $allItems[0]['title'] : 'Registrar Profile & Secretariat';
      ...
      <div class="reg-grid-layout">
        ...
        <div>
          <article class="reg-block-card">
            <div class="reg-card-header">
              <h2 class="reg-card-title"><?= htmlspecialchars($regTitle) ?></h2>
        ...
        <aside>
          <div class="sidebar-card">
            <h3 class="sidebar-title">Leadership &amp; Administration</h3>
