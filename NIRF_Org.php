...
<section id="contentLeft">
	...
	<h2 class="titleDescription"><a href="NIRF.php"><span>&nbsp;</span>NIRF </a></h2>
	<p class="titleDescription">&nbsp;</p>
	<p class="titleDescription">&nbsp;</p>
		<!--<p class="titleDescription"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="nirf 2020.pdf" target="_blank"><strong>&nbsp;All_Report-MHRD__National_Institutional_Ranking_Framework_(NIRF 2020)</strong></a></p>-->
		<p class="titleDescription"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="nirf 2021.pdf" target="_blank"><strong>All Report - MHRD National Institutional Ranking Framework (NIRF 2021)</strong></a></p>


	<p class="titleDescription">&nbsp;</p>
	<p class="titleDescription">&nbsp;</p>
	<p class="titleDescription">&nbsp;</p>
	<p align="justify">Comments and feedback on above NIRF data can be mailed to: nirffeedback@rkdf.ac.in </p>
