...
?>
    ...
    <section id="content" class="wrapper ">
        ...
        <section id="contentLeft">
            ...
            <ul>
                <li class="style9">
                    <table width="644" height="650" border="1" cellpadding="0" cellspacing="0">
						...
						-->
                        <tr>
                            <td height="52" colspan="2"><span class="style3"><br />
                                    Syllabus According to New Education Policy (NEP) </span></td>
                        </tr>
                        <tr>
                            <td height="31" colspan="2"><span class="style3">
                                    NEP MINOR 2ND YEAR SYLLABUS </span></td>
                        </tr>
                        <tr height="40">
                            <td width="516"><a href="syllabus/NEP/MINOR/Physics.pdf" target="_blank"><strong> B.SC
                                        (PHYSICS)</strong></a></td>
                            <td width="73">&nbsp;</td>
                        </tr>
                        <tr height="40">
                            <td><a href="syllabus/NEP/MINOR/BSc. Zoology (Minor) 2nd Year -  NEP 2020 – Session 2023-24.pdf" target="_blank"><strong>B.SC
                                        (ZOOLOGY)</strong></a></td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr height="40">
                            <td><a href="syllabus/NEP/MINOR/Chemistry.pdf" target="_blank"><strong>B.SC (CHEMISTRY)
                                    </strong></a></td>
                            <td>&nbsp;</td>
                        </tr>
						...
						-->
                        <tr height="40">
                            <td><a href="syllabus/NEP/MINOR/BSc. Botany (Minor) 2nd  Year -  NEP 2020 – Session 2023-24.pdf" target="_blank"><strong>B.SC
                                        (BOTANY)</strong></a></td>
                            <td>&nbsp;</td>
                        </tr>

                        <tr height="40">
                            <td><a href="syllabus/NEP/MINOR/mathematics.pdf" target="_blank"><strong>B.SC
