...
<body>
    <header id="header">
		...
		color:#292A2F;*/
                        ...
                        max-width: 25%; /* Each image takes up roughly 25% of the container */
...
?>
    ...
    <section id="content" class="wrapper ">
        ...
        <section id="contentLeft">
            <div id="collegeDetail" style="min-height: 2px !important;">
                <h2 class="titleDescription">
                    <a href="#" class="style4"><font color="#FF1111">Healthcare @ RKDF University</font> </a> 
                </h2>
            </div>

            <!-- <p>
                <a href="#"  target=_blank"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/img/new24.gif" />
                <span class="style1">&nbsp;&nbsp; Librarian Name: </span></span></strong></a>&nbsp;</p><p>&nbsp;
            </p> -->

            <div class="col-md-12 textAlignment" style="text-align: justify" ;="">
                <article>
                    <p>
                        </p><h2>Health Care Facility @ RKDF University</h2>
                        <hr>
                    <p></p>
                    <p>
                    The students are provided with facilities for medical care and treatment in the college dispensary at college cost. Consultation and distribution of medicines to students is done by expert doctors & staff.
                    </p>
                    <br>
                    <p>
                    The University regularly organizes health check-up camps and awareness programmes related to health for the overall benefit of its students, staff and the community in general.<br><br>Well-known doctors are regularly visiting the dispensary.
                    </p>
                    <p>
                    <p></p>
                    <br><br>

                    <div class="image-container" style="display:flex; justify-content: center; align-items: center; margin: 0;">
                        <img src="images/healthcare/HealthCare-01.jpg" alt="Image 2" style="max-width: 50%;">
                        <img src="images/healthcare/HealthCare-02.jpg" alt="Image 3" style="max-width: 50%;">
                    </div>
                    <br><br>
                </article>
            </div>
