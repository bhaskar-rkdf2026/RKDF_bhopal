...
<section id="contentLeft">
	...
	<h2 class="titleDescription"><a href="Health-Care-Medical-Center.php"><span>&nbsp;</span> Health Care &amp; Medical Center </a></h2>
	<p class="titleDescription">&nbsp;</p>
	<p><img src="images/img/health.jpeg" width="275" height="183" /></p>
	...
	<ul>
	  <li>
	    <p>The students are provided with facilities for medical care and treatment in the college dispensary at college cost. Consultation and distribution of medicines to students is done by expert doctors &amp; staff. </p>
	    </li>
	  <li>
	    <p>The University regularly organizes health check-up camps and awareness programmes related to health for the overall benefit of its students, staff and the community in general.</p>
	    </li>
	  <li>
	    <p>Well-known doctors are regularly visiting the dispensary.</p>
	    </li>
	  </ul>
	<p><strong> </strong></p>
	<p>&nbsp; </p>
  ...
  <section id="sideBar">
			...
			<h2> Health Care &amp; Medical Center </h2>
