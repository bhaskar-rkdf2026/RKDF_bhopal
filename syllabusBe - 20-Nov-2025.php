            ...
            <ul>
                <li class="style9">
                    <table width="400" border="1">
                        <tr>
                            <td ><span class="style3"><br />1st & 2nd Sem Common</span></td>
                            <td>&nbsp;</td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="2"  style="color:black; font-size:medium"> B.E. (AI & Data Science Engineering) </td>
							<td colspan="2">
                        ...
                        <tr>
                            <td colspan="2"  style="color:black; font-size:medium"> B.E. (CSE- IoT & Cyber Security Engineering) </td>
							<td colspan="2">
