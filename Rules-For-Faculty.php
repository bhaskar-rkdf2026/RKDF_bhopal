...
<section id="contentLeft">
	...
	<h2 class="titleDescription"><a href="Rules-For-Faculty.php"><span>&nbsp;</span> RKDF Rules For Faculty </a></h2>
	<p class="titleDescription">&nbsp;</p>
	<h2 class="style6"> <strong><em><a href="#">Rules for Skil Up-gradation of Faculty members</a></em></strong></h2>
	</div>
  ...
  <section id="sideBar">
			  <aside id="customMenu" class="sidebarWidget">
                <h2>Rules For Faculty</h2>
			    <div class="glossymenu"> 
				<a class="menuitem" href="Rules-For-Faculty.php"><img src="images/bullet.png" /> Rules For Faculty </a> 
				...
				<a class="menuitem" href="international-relation.php"><img src="images/bullet.png" />International Relations </a>
