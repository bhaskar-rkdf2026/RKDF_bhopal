...
<h2 class="titleDescription"><a href="#">  ( MANAGEMENT ) Syllabus</a></h2>
                ...
                <ul>
                  <li class="style9">
                    <table width="200" border="1">
                      ...
                      <tr>
                        <td width="388" height="35"><span class="style3">
                        &nbsp;&nbsp;&nbsp;BBA Syllabus According to New Education Policy (NEP) </span></td>
                        <td width="167">&nbsp;</td>
                        <td width="73">&nbsp;</td>
                      </tr>
					  <tr>
                        <td width="388" height="25" ><a href="syllabus/MBA/BBA NEP 1st Year Syllabus.pdf" target="_blank"><strong> BBA  1st & 2nd Semester  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong></a></td>
						<td width="167">&nbsp;</td>
                        <td>&nbsp;</td>
                      </tr>
					  <tr>
                        <td width="388" height="25" ><a href="syllabus/NEP/BBA-2nd-Year.pdf" target="_blank"><strong> BBA 2nd Year  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong></a></td>
						<td width="167">&nbsp;</td>
                        <td>&nbsp;</td>
                      </tr>
					   <tr>
                        <td colspan="2"><a href="syllabus/NEP/BBA-ENVIRONMNT SYLLSBUS.pdf" target="_blank"><strong>&nbsp;BBA Environmental Studies&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong></a></td>
                        <td>&nbsp;</td>
                      </tr>					  
					  <tr>
                        <td colspan="2"><a href="syllabus/NEP/BBA III YEAR SYllabus NEP 15-02-24.pdf" target="_blank"><strong>&nbsp;BACHELOR OF BUSINESS ADMINISTRATION (BBA) - III Year (Semester V & VI)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong></a></td>
                        <td>&nbsp;</td>
                      </tr>
					  
					    <tr  valign="bottom">
                        <td width="388" height="36"><span class="style3"><br />
                        &nbsp;&nbsp;&nbsp;BBA  </span></td>
                        <td width="167">&nbsp;</td>
                        <td width="73">&nbsp;</td>
                      </tr>
					  <tr>
                        <td width="388" height="31" ><a href="syllabus/MBA/BBA All Sem.pdf" target="_blank"><strong> BBA  1st to 6th Semester &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong></a></td>
						<td width="167">&nbsp;</td>
                        <td>&nbsp;</td>
                      </tr>
					  <tr>
                        <td width="388" height="29"><span class="style3">
                        &nbsp;&nbsp;&nbsp;MBA  </span></td>
                        <td width="167">&nbsp;</td>
                        <td width="73">&nbsp;</td>
                      </tr>
                      <tr>
                        <td width="388"><a href="syllabus/MBA/MBA 1st Yr new.pdf" target="_blank"><strong> &nbsp; MBA 1st & 2nd Sem.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong></a></td>
                        <td width="167">&nbsp;</td>
						<td>&nbsp;</td>
                      </tr>
					  <tr>
                        <td width="388"><a href="syllabus/MBA/MBA 3rd sem new.pdf" target="_blank"><strong> &nbsp; MBA 3rd Sem (New Scheme).&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong></a></td>
                        <td width="167">&nbsp;</td>
						<td>&nbsp;</td>
                      </tr>
					  <tr>
                        <td width="388"><a href="syllabus/MBA/MBA III sem.pdf" target="_blank"><strong> &nbsp; MBA 3rd Sem (Old Scheme).&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong></a></td>
                        <td width="167">&nbsp;</td>
						<td>&nbsp;</td>
                      </tr>
					  <tr>
                        <td width="388" ><a href="syllabus/MBA/MBA 4th  Sem New.pdf" target="_blank"><strong>&nbsp; MBA 4th Sem (New Scheme).&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong></a></td>
                        <td width="167">&nbsp;</td>
						<td>&nbsp;</td>
                      </tr>
					  <tr>
                        <td width="388" ><a href="syllabus/MBA/MBA IV sem.pdf" target="_blank"><strong>&nbsp; MBA 4th Sem (Old Scheme).&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong></a></td>
                        <td width="167">&nbsp;</td>
						<td>&nbsp;</td>
                      </tr>
					  <tr>
