            ...
            <ul>
                <li class="style9">
                    <table width="644" height="650" border="1" cellpadding="0" cellspacing="0">
                        ...
                        <tr  height="40">
                            <td width="516"><a href="syllabus/NEP/MINOR/Physics.pdf"
                                    target="_blank"><strong> B.SC (PHYSICS)</strong></a></td>
                            <td width="73">&nbsp;</td>
                        </tr>
                        <tr  height="40">
                            <td><a href="syllabus/NEP/MINOR/Zoology.pdf"
                                    target="_blank"><strong>B.SC (ZOOLOGY)</strong></a></td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr  height="40">
                            <td><a href="syllabus/NEP/MINOR/Chemistry.pdf"
						...
						-->
                        <tr  height="40">
                            <td><a href="syllabus/NEP/MINOR/Botany.pdf"
                                    target="_blank"><strong>B.SC (BOTANY)</strong></a></td>
                            <td>&nbsp;</td>
                        </tr>
                       
                        <tr  height="40">
                            <td><a href="syllabus/NEP/MINOR/mathematics.pdf"
