<?php
// scratch/build_convocation2024.php
$filePath = __DIR__ . '/../Convocation-2024.php';
...
echo "Found " . count($matches) . " convocation 2024 photos.\n";
...
foreach ($matches as $item) {
    ...
    if (empty($captionText)) $captionText = "Convocation Ceremony - 04th May 2024";
...
echo "Successfully rebuilt Convocation-2024.php with " . count($matches) . " photo items!\n";
