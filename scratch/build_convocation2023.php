<?php
// scratch/build_convocation2023.php
$filePath = __DIR__ . '/../Convocation-2023.php';
...
echo "Found " . count($matches) . " convocation 2023 photos.\n";
...
foreach ($matches as $item) {
    ...
    if (empty($captionText)) $captionText = "Convocation Ceremony - 25th April 2023";
...
echo "Successfully rebuilt Convocation-2023.php with " . count($matches) . " photo items!\n";
