<?php
// ============================================================
// RKDF University — Polytechnic (Diploma in Engineering) Syllabus
...
<head>
  ...
  <title>Polytechnic (Diploma) Syllabus — RKDF University Bhopal</title>
  ...
  <style>
    .subpage-hero {
      ...
      background: linear-gradient(135deg, rgba(12,20,36,0.94) 0%, rgba(21,34,56,0.90) 60%, rgba(12,20,36,0.96) 100%), 
                  url('images/ai_syllabus_poly/rkdf_syll_poly_banner.jpg') center/cover no-repeat;
      color: #FAF9F5;
    ...
    @media (max-width: 992px) {
      .spoly-grid-layout { grid-template-columns: 1fr; }
    }
    ...
    .spoly-block-card:hover .spoly-media-img {
...
<body>
  ...
  <main class="spoly-main-section">
    <div class="rk-container">
      <div class="spoly-grid-layout">
        ...
        <div>
          ...
          <article class="spoly-block-card">
            ...
            <div class="spoly-card-body">
              ...
              <div class="spoly-media-frame">
                <img src="images/ai_syllabus_poly/rkdf_syll_poly_card.jpg" alt="RKDF Polytechnic Engineering Workshop &amp; Technical Labs" class="spoly-media-img">
              </div>

              <div style="font-family:'Playfair Display',serif;font-size:22px;color:#C5A059;margin-bottom:14px;font-weight:700;">
                Polytechnic Engineering Diploma Modules (Semesters 1 to 6)
              </div>
              ...
              <!-- DOWNLOAD ROWS -->
              <div class="spoly-download-list">

                <div class="spoly-download-row">
                  <div class="spoly-row-info">
                    <span style="font-size:22px;">⚙️</span>
                    <span class="spoly-row-title">DIPLOMA POLYTECHNIC (1st Year All Branches)</span>
                  </div>
                  <a href="syllabus/Technical%20syllabus/polytechnic.pdf" target="_blank" class="spoly-pdf-link">📄 Download PDF ↗</a>
                </div>

                <div class="spoly-download-row">
                  <div class="spoly-row-info">
                    <span style="font-size:22px;">🛠️</span>
                    <span class="spoly-row-title">DIPLOMA POLYTECHNIC (Mechanical Engineering · ME Branch 1st to 6th Sem)</span>
                  </div>
                  <a href="syllabus/Technical%20syllabus/POLY%20ME%20BRANCH.pdf" target="_blank" class="spoly-pdf-link">📄 Download PDF ↗</a>
                </div>

                <div class="spoly-download-row">
                  <div class="spoly-row-info">
                    <span style="font-size:22px;">🏗️</span>
                    <span class="spoly-row-title">DIPLOMA POLYTECHNIC (3rd to 6th Sem All Branches)</span>
                  </div>
                  <a href="syllabus/Technical%20syllabus/poly%20all%20branch%203rd%20to%206th.pdf" target="_blank" class="spoly-pdf-link">📄 Download PDF ↗</a>
                </div>
