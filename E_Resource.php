...
<!--- header -->	<section id="content" class="wrapper ">
  <!--- spotlight -->
  <span class="style13">LIBRARY &nbsp;  E-RESOURCES  </span>
  <!--- contentLeft -->
   <p>&nbsp;</p> 
  <section id="sideBar">			</section>
			<!--- sideBar -->
			<table width="654" height="525" border="0" cellspacing="1" cellpadding="1">
              <tr>
                <td width="158" height="67"><a href="eresourse_login.php"> <img src="images/img/swayam.png" width="155" height="101" /></a></td>
                <td width="273"><a href="eresourse_login.php"><img src="images/img/shodh-ganga.gif" width="155" height="70" /></a></td>
                <td width="16"><a href="eresourse_login.php"><img src="images/img/iit.png" width="140" height="100" /></a></td>
                <td width="91"><a href="eresourse_login.php"><img src="images/img/ndl.png" width="155" height="70" /></a></td>
                <td width="78"><a href="eresourse_login.php"><img src="images/img/Delnet.jpg" width="155" height="70" /></a></td>
              </tr>
			   <tr>
                <td height="33">&nbsp; </td>
                <td>&nbsp;</td>
			   ...
			   <tr>
                <td width="158" height="67"><a href="eresourse_login.php"> <img src="images/img/nptel.jpg" width="140" height="60" /></a></td>
                <td width="273"><a href="eresourse_login.php"><img src="images/img/epg.png" width="155" height="100" /></a></td>
                <td width="16"><a href="eresourse_login.php"><img src="images/img/iitbbslogo.jpg" width="130" height="100" /></a></td>
                <td width="91"><a href="eresourse_login.php"><img src="images/img/rgpv elib.jpg" width="155" height="100" /></a></td>
                <td width="78"><a href="eresourse_login.php"><img src="images/img/du-logo.png" width="140" height="100" /></a></td>
              </tr>
			   <tr>
                <td height="33">&nbsp;</td>
                <td>&nbsp;</td>
			   ...
			   <tr>
                <td width="158" height="67"><a href="eresourse_login.php"><img src="images/img/OKR.jpg" width="155" height="101" /></a></td>
                <td width="273"><a href="eresourse_login.php"><img src="images/img/pglib.png" width="155" height="70" /></a></td>
                <td width="16"><a href="eresourse_login.php"><img src="images/img/nih.png" width="140" height="100" /></a></td>
                <td width="91"><a href="eresourse_login.php"><img src="images/img/highwire.jpg" width="155" height="70" /></a></td>
                <td width="78"><a href="eresourse_login.php"><img src="images/img/science.png" width="155" height="70" /></a></td>
              </tr>
              ...
              <tr>
                <td width="150" height="82"><a href="eresourse_login.php"><img src="images/img/abhilekh-patel.jpg" width="155" height="70" /></a></td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
