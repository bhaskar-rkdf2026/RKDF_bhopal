...
<section id="contentLeft">
	...
	<h2 class="titleDescription"><a href="Recruitment.html"><span>&nbsp;</span> Recruitment </a></h2>
	<p class="titleDescription">&nbsp;</p>
	<ul>
	  <li>
	    <pre class="style19">&nbsp;</pre>
	    </li>
	  <li> <strong>Recent Opening OCT-2012</strong></li>
	  </ul>
	<p>&nbsp;</p>
	<ul>
	  <li type="square">
	    <p class="style28"><a href="#">Advertisement Of post Of Registrar</a></p>
	  </li>
	  <li type="square">
	    <p class="style28"><a href="#">Instruction to Candidates <br />
	      </a></p>
	  </li>
	  <li type="square">
	    <p class="style28"><a href="#">Application Form</a></p>
	  </li>
	  <li type="square">
	    <p class="style28"><a href="#">PayScal</a></p>
	  </li>
	  <li></li>
	</ul>
	<p class="style18">&nbsp; </p>
	<p class="style18">“The Candidates having Qualification as per UGC norms and from Public/Semi Government/Govt. Sector/Private Sector can also be considered on Deputation the advertised posts” </p>
	<ul>
	  <li></li>
	  <li></li>
	  </ul>
...
<a class="menuitem" href="index.html"><img src="images/bullet.png" /> Home </a>
<a class="menuitem" href="Recruitment.html"><img src="images/bullet.png" />Recruitment</a>
