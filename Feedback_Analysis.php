...
<section id="contentLeft">
				...
				<h2 class="titleDescription"><font color="#003366"> <b>FEEDBACK FORMS  </b></font> </h2>
	<blockquote>
	  <p class="style14">&nbsp;</p>
	</blockquote>
	<blockquote>
	  <table width="900" border="1" cellpadding="0" cellspacing="0">
	   <tr>
       <td width="890" height="39"><h3 class="titleDescription"><a href="forms/Parent’s_Feedback_Form.pdf" target="_blank" > <font color="#55AAFF">&nbsp;&nbsp;Parent's Feedback Form  </font> </a></h3> </td>
      </tr>
	  <tr>
       <td width="890" height="38"><h3 class="titleDescription"><a href="forms/Student’s_Feedback_Form.pdf" target="_blank" > <font color="#55AAFF">&nbsp;&nbsp;Student Feedback Form </font> </a></h3> </td>
      </tr>
	  <tr>
       <td width="890" height="41"><h3 class="titleDescription"><a href="forms/Teacher's_Feedback_form.pdf" target="_blank" > <font color="#55AAFF">&nbsp;&nbsp;Teacher's Feedback Form  </font> </a></h3> </td>
      </tr>
	   <tr>
       <td width="890" height="41"><h3 class="titleDescription"><a href="forms/Alumni's_Feedback_Form.pdf" target="_blank" > <font color="#55AAFF">&nbsp;&nbsp;Alumni's Feedback Form </font> </a></h3> </td>
      </tr>
	   <tr>
       <td width="890" height="41"><h3 class="titleDescription"><a href="forms/Employer's_Feedback_Form.pdf" target="_blank" > <font color="#55AAFF">&nbsp;&nbsp;Employer's Feedback Form </font> </a></h3> </td>
      </tr>
	  <tr>
       <td width="890" height="41"><h3 class="titleDescription"><a href="https://rkdf.ac.in/naac/criteria1/1.4/1.4.1/final%20feedback%20analysis%20report.pdf" target="_blank" > <font color="#55AAFF">&nbsp;&nbsp;Feedback Analysis  Report</font> </a></h3> </td>
      </tr>
