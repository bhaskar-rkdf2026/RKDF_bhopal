			...
			<ul>
				...
				<table width="673" border="1" cellpadding="1" cellspacing="0">
					...
					<tr>
						...
						<td >&nbsp;<a href="syllabus/Value-Added-Course/VAC - Aagni Veer" target="_blank" class="style6">OPEN</a></td>
					</tr>
					<tr>
						<td height="52" class="style8">&nbsp;A basic Course on Diet Nutrition (VCDN) </td>
						<td width="196" height="52" class="style8">&nbsp;Ms. Rimpa Manna </td>
					...
					<tr>
						...
						<td width="196" height="52" class="style8">&nbsp;Dr. C.B.S. Dangi</td>
