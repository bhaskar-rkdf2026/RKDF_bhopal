...
<section id="contentLeft">
	...
	<h2 class="titleDescription"><a href="Laboratories.php"><span>&nbsp;</span> Laboratories   </a></h2>
	<p class="titleDescription">&nbsp;</p>
	<ul>
	  <li><img src="images/img/lab1.png" width="252" height="175" /><span class="style9"><img src="images/img/lab2.png" width="256" height="170" /></span></li>
	  </ul>
	<ul>
	  <li></li>
	  <li><img src="images/img/lab3.png" width="252" height="165" /><img src="images/img/lab4.png" width="252" height="165" /></li>
	  </ul>
	...
	<p>&nbsp;</p>
	<p>&nbsp; </p>
	<p><span class="style12">...............</span>RKDF invests substantially in computer equipment and latest softwares to ensure that students have ready access to up to date technology. There is a dedicated Internet center available to the students, essentially for web browsing purpose, with a reasonable number of computers. A centralized Internet browsing facility is made available for students and staff members. It is connected with a lease line, to facilitate high speed Internet surfing. </p>
	<p class="style11">&nbsp;</p>
	</div>
