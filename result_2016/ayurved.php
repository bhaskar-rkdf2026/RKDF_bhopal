...
if(!$con)
	...
	$xrno=$_SESSION['xrno'];
$qry = "SELECT * FROM  ayurvedic_online WHERE rollno='".$xrno."'";
...
<table class="bg" width="68%"  border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
   ...
   <tr>
    <td colspan="3">
	<table width="98%" height="96"  border="1" cellpadding="0" cellspacing="0">
        <tr>
          <td colspan="4" >&nbsp;</td>
        </tr>
		<tr>
          <td width="31%" height="25" class="fonttb" ><strong>&nbsp;ROLL NO. : </strong></td>
          <td width="41%" class="fonttb" ><strong><?php echo $rno; ?></strong> </td>
          <td width="15%" class="fonttb" ><div align="center"><strong>STATUS :</strong></div></td>
          <td width="13%" class="fonttb"><div align="left"><strong>Regular</strong></div></td>
        </tr>
		<tr>
          <td width="31%" class="fonttb" ><strong>NAME OF STUDENT : </strong></td>
          <td colspan="3" class="fonttb" ><strong><?php echo $name; ?></strong>            <div align="center"><strong></strong></div>            <div align="left"><strong></strong></div></td>
        </tr>
  ...
  <tr>
    <td height="27" colspan="3" align="center"><strong>DIPLOMA CERTIFICATE IN AYURVEDIC COMPOUNDER</strong></td>
  </tr>
  <tr>
    <td colspan="3">
	<table width="99%" height="100%" border="1" cellpadding="0" cellspacing="0">
        <tr>
          <td width="121" rowspan="3" class="fonttb"><div align="center"><strong>SUBJECT CODE </strong></div></td>
          <td width="281" rowspan="3" class="fonttb"><div align="center"><strong>&nbsp;&nbsp; TITLE OF PAPER &nbsp;&nbsp; </strong></div></td>
          <td width="83" rowspan="3" class="fonttb"><div align="center"><strong>MARKS TOTAL</strong></div></td>
		  
          <td colspan="5" class="fonttb"><div align="center"><strong>MARKS OBTAINED </strong></div></td>
        </tr>
        <tr>
		  <td width="65" height="35" class="fonttb"><div align="center"><strong>THEORY</strong></div></td>
          <td width="82" class="fonttb"><div align="center"><strong>INTERNAL</strong></div></td>
          <td width="93" class="fonttb"><div align="center"><strong>PRACTICAL</strong></div></td>
          <td width="133" class="fonttb"><div align="center"><strong>TOTAL MARKS </strong></div></td>
        </tr>
        <tr> </tr>
        <tr>
          ...
          <td class="fonttb"><div align="center"><strong> 200 </strong> </div></td>
        ...
        <tr>
          <td height="32" class="fonttb"><div align="center"><strong><?php echo $subcode2; ?></strong></div></td>
        ...
        <tr>
          <td height="34" class="fonttb"><div align="center"></div></td>
          <td class="fonttb"><div align="left"></div></td>
  ...
  <tr>
	...
	<table width="87%" height="56" border="1" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td width="208" rowspan="2" class="fonttb"><div align="center"><strong>GRAND TOTAL : </strong></div></td>
          <td width="138" height="20" class="fonttb"><strong>IN FIGURES </strong></td>
          <td width="415" class="fonttb"><strong><?php echo $grandtotalfig; ?> / 400</strong> </td>
        </tr>
        <tr>        </tr>
        <tr>
          <td height="34" class="fonttb"><div align="center"><strong>RESULT : </strong></div></td>
  ...
  <tr>
    <td colspan="3"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NOTE:-</strong> This is a Computer Generated Statement Should Not Be Treated As Original* </td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
