...
if(!$con)
	...
	$xrno=$_SESSION['xrno'];
$qry = "SELECT * FROM  dca2017 WHERE rollno='".$xrno."'";
...
<table class="bg" width="68%"  border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="57" colspan="2" align="center"><span class="style1 style7">STATEMENT OF MARKS - Session- April-22</span></td>
  </tr>
   <tr>
    <td colspan="3">
	<table width="98%" cellpadding="0" cellspacing="0"  border="1">
		...
		<tr>
          <td width="36%" class="fonttb" ><strong>&nbsp;ROLL NO. : </strong></td>
          <td width="37%" class="fonttb" ><strong><?php echo $rno; ?> </strong></td>
		...
		<tr>
          <td width="36%" class="fonttb" ><strong>NAME OF STUDENT : </strong></td>
        <td width="37%" class="fonttb" ><strong><?php echo $name; ?> </strong></td>
          <td width="16%" class="fonttb" >&nbsp;</td>
