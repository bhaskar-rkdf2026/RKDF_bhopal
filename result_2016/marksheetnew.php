...
if(!$con)
	...
	$xrno=$_SESSION['xrno'];
$qry = "SELECT * FROM  resultvithsem WHERE rollno='".$xrno."'";
  ...
  <tr>
   ...
   <tr>
	...
	<table width="97%" cellpadding="0" cellspacing="0"  border="1">
		...
		<tr>
          <td width="30%" class="fonttb" ><strong>&nbsp;ROLL NO. : </strong></td>
          <td width="43%" class="fonttb" ><strong><?php echo $rno; ?></strong> </td>
          <td width="15%" class="fonttb" ><div align="center"><strong>STATUS :</strong></div></td>
          <td width="12%" class="fonttb"><div align="left"><strong>Regular</strong></div></td>
        </tr>
		<tr>
          <td width="30%" class="fonttb" ><strong>NAME OF STUDENT : </strong></td>
          <td width="43%" class="fonttb" ><strong><?php echo $name; ?></strong></td>
          <td width="15%" class="fonttb" ><div align="center"><strong>SEMESTER :</strong></div></td>
          <td width="12%" class="fonttb"><div align="left"><strong>VIth</strong></div></td>
        </tr>
