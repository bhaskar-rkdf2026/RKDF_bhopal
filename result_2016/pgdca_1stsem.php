...
<?php */?>
<?php
$con=mysql_connect("localhost","root","rootwdp"); if(!$con)
			 {
			    die ('could not connect').mysql_error();
		  	 }
	mysql_select_db("rkhare_result2013",$con);
	$xrno=$_SESSION['xrno'];
$qry = "SELECT * FROM  pgdca1stsem_2014 WHERE rollno='".$xrno."'";
   ...
   <tr>
	...
	<table width="98%" cellpadding="0" cellspacing="0"  border="1">
		...
		<tr>
          ...
          <td width="11%" class="fonttb"><div align="left"><strong>EX</strong></div></td>
        </tr>
		<tr>
          <td width="29%" class="fonttb" ><strong>NAME OF STUDENT : </strong></td>
        <td width="42%" class="fonttb" ><strong><?php echo $name; ?> </strong></td>
          <td width="18%" class="fonttb" ><div align="left"><strong>SEMESTER :</strong></div></td>
          <td width="11%" class="fonttb"><div align="left"><strong>Ist</strong></div></td>
        </tr>
