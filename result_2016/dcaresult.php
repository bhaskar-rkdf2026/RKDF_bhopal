...
<table  background="../images/footerBg.png"  align="center" width="1026" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td colspan="3"><table width="1024" border="0" background="images/dBg.jpg" cellpadding="0" cellspacing="0">
      <tr>
        <td width="1023" bgcolor="#000046">
		<img src="../images/img/logo22.png" width="812"
                height="111" />
            <img src="../images/img/approval.gif" width="100" height="112" />		</td>
      </tr>
    </table></td>
  </tr>
  <tr >
  ...
  <tr>
    <td width="6">&nbsp;</td>
    <td width="965">
<form method="post" action="dca_login.php">
	<table  width="965" height="249" border="0" background="../images/dropdownBg.png">
      <tr>
        <td width="8" height="55">&nbsp;</td>
        <td width="320">&nbsp;</td>
        <td width="623"> &nbsp;<span class="style11">&nbsp;RESULT : DCA April 2024</span></td>
      </tr>
      <tr>
        <td height="41">&nbsp;</td>
