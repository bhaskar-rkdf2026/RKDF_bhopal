...
if(!$con)
	...
	$xrno=$_SESSION['xrno'];
$qry = "SELECT * FROM  firesafety15 WHERE rollno='".$xrno."'";
...
while ($row = mysql_fetch_array($result))  
  {
	...
	$dmarkstotal9=$row["dmarkstotal9"];
	$dmarkstotal10=$row["dmarkstotal10"];
	$theory=$row["theory"];
	$theory2=$row["theory2"];	
	$theory3=$row["theory3"];	
	$theory4=$row["theory4"];	
	...
	$prectical9=$row["prectical9"];	
	$prectical10=$row["prectical10"];						
	...
	$omarkstotal9=$row["omarkstotal9"];	
	$omarkstotal10=$row["omarkstotal10"];		
...
?>
<table class="bg" width="67%"  border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
  ...
  <tr>
	...
	<table width="98%" height="100%" border="1" cellpadding="0" cellspacing="0">
		...
		<tr>
          <td height="23" class="fonttb"><div align="center"><strong><?php echo $subcode9; ?></strong></div></td>
          <td class="fonttb"><div align="left"><strong><?php echo $paper9; ?></strong></div></td>
          <td class="fonttb"><div align="center"><strong><?php echo $dmarkstotal9; ?></strong></div></td>
          <td class="fonttb"><div align="center"><strong><?php echo "-"; ?></strong></div></td>
          <td class="fonttb"><div align="center"><strong><?php echo $prectical9; ?></strong></div></td>
          <td class="fonttb"><div align="center"><strong><?php echo $omarkstotal9; ?></strong></div></td>
        </tr>
		<tr>
          <td height="23" class="fonttb"><div align="center"><strong><?php echo $subcode10; ?></strong></div></td>
          <td class="fonttb"><div align="left"><strong><?php echo $paper10; ?></strong></div></td>
          <td class="fonttb"><div align="center"><strong><?php echo $dmarkstotal10; ?></strong></div></td>
          <td class="fonttb"><div align="center"><strong><?php echo "-"; ?></strong></div></td>
          <td class="fonttb"><div align="center"><strong><?php echo $prectical10; ?></strong></div></td>
          <td class="fonttb"><div align="center"><strong><?php echo $omarkstotal10; ?></strong></div></td>
        </tr>
