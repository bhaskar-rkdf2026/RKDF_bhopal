...
<?php
 $con=mysql_connect("localhost","rkhare_prashant","Vcwbtbcpii09");
  if(!$con)
	...
	$xrno=$_SESSION['xrno'];
$qry = "SELECT * FROM  med14 WHERE rollno='".$xrno."'";
  ...
  <tr>
	...
	<table width="100%" height="100%" border="1" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td width="98" class="fonttb"><div align="center"><strong>INTERNAL</strong></div></td>
  ...
  <tr>
	...
	<table width="95%" height="71" border="1" align="center" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td width="437" height="27" class="fonttb"><strong><?php echo $grandtotalfig." / 700"; ?></strong></td>
