...
if(!$con)
	...
	$xrno=$_SESSION['xrno'];
$qry = "SELECT * FROM  resultback WHERE rollno='".$xrno."'";
   ...
   <tr>
	...
	<table width="97%" cellpadding="0" cellspacing="0"  border="1">
		...
		<tr>
          ...
          <td width="12%" class="fonttb"><div align="left"><strong>EX</strong></div></td>
        </tr>
		<tr>
          ...
          <td width="12%" class="fonttb"><div align="left"><strong>FIRST</strong></div></td>
        </tr>
