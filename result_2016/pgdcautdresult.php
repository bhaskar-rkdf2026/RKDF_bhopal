...
<table  background="../images/footerBg.png"  align="center" width="1026" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td colspan="3"><table width="1023" border="0" background="images/dBg.jpg" cellpadding="0" cellspacing="0">
      <tr>
...
<form method="post" action="pgdcautd_login.php">
	<table  width="965" height="249" border="0" background="../images/dropdownBg.png">
      <tr>
        ...
        <td width="320">&nbsp;</td>
        <td width="623"> &nbsp;<span class="style11">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;PGDCA&nbsp;RESULT - April - 2024 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span></td>
      </tr>
      <tr>
        <td height="41">&nbsp;</td>
