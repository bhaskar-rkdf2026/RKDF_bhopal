...
if(!$con)
	...
	$xrno=$_SESSION['xrno'];
$qry = "SELECT * FROM  pgdca2016 WHERE rollno='".$xrno."'";
   ...
   <tr>
	...
	<table width="98%" cellpadding="0" cellspacing="0"  border="1">
		...
		<tr>
          ...
          <td width="15%" class="fonttb" ><div align="left"><strong>STATUS :</strong></div></td>
        ...
        <td width="44%" class="fonttb" ><strong><?php echo $name; ?> </strong></td>
          <td width="15%" class="fonttb" >&nbsp;</td>
          <td width="12%" class="fonttb">&nbsp;</td>
		</tr>
