            ...
            <ul>
                <li class="style9">
                    <table width="200" border="1">
                        <tr>
                            <td style="font-size: 18px !important;padding-bottom: 15px;"><span class="style3"><br />
                                    1st to 2nd Year ( 1st to 4th SEM ALL ) </span></td>
                            <td width="167">&nbsp;</td>
                            <td width="73">&nbsp;</td>
                        </tr>
                        <tr>
                            <td colspan="2" style="padding-bottom: 12px;padding-top: 12px;"><a
                                    href="syllabus/Technical syllabus/M.Tech/M.Tech. Computer Science & Engg.pdf"
                                    target="_blank"><strong>M.Tech ( Computer Sc. and Engg. )</strong></a></td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
                            <td colspan="2" style="padding-bottom: 12px;padding-top: 12px;"><a
                                    href="syllabus/Technical syllabus/M.Tech/M.Tech. Digital Communication.pdf"
                                    target="_blank"><strong>M.Tech ( Digital Communication )</strong></a></td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
                            <td colspan="2" style="padding-bottom: 12px;padding-top: 12px;"><a
                                    href="syllabus/Technical syllabus/M.Tech/M.Tech. Power Electronics.pdf"
                                    target="_blank"><strong>M.Tech (Power Electronics )</strong></a></td>
                            <td>&nbsp;</td>
                        </tr>

                        <tr>
                            <td colspan="2" style="padding-bottom: 12px;padding-top: 12px;"><a
                                    href="syllabus/Technical syllabus/M.Tech/M.Tech. Power System.pdf"
                                    target="_blank"><strong>M.Tech ( Power System )</strong></a></td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
                            <td colspan="2" style="padding-bottom: 12px;padding-top: 12px;"><a
                                    href="syllabus/Technical syllabus/M.Tech/M.Tech. VLSI.pdf"
                                    target="_blank"><strong>M.Tech ( VLSI Design. )</strong></a></td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
                            <td colspan="2" style="padding-bottom: 12px;padding-top: 12px;"><a
                                    href="syllabus/Technical syllabus/M.Tech/M.Tech Thremal.pdf"
                                    target="_blank"><strong>M.Tech ( Thermal)</strong></a></td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
                            <td colspan="2" style="padding-bottom: 12px;padding-top: 12px;"><a
                                    href="syllabus/Technical syllabus/M.Tech/M.Tech_PI.pdf"
                                    target="_blank"><strong>M.Tech ( Production & Industrie(PI) )</strong></a></td>
                            <td>&nbsp;</td>
                        </tr>

						<tr>
                            <td
                                style="padding-bottom: 12px;padding-top: 12px;font-size: medium;color: #666666;width: 63%;">
                                <strong><a>Construction Technology & Management (CTM)</a></strong>
                            </td>
                            <td><a href=" syllabus/Technical syllabus/M.Tech/M.Tech_PI.pdf"
                                    target="_blank"><strong>Scheme</strong></a></td>

                            <td><a href="syllabus/Technical syllabus/M.Tech/ctm/M TECH -CTM_Syllabus _1sem.pdf"
                                    target="_blank"><strong>Syllabus</strong></a></td>
                        </tr>

                        <tr>
                            <td
                                style="padding-bottom: 12px;padding-top: 12px;font-size: medium;color: #666666;width: 63%;">
                                <strong><a>Structure Engineering (SE) Syllabus</a></strong>
                            </td>
                            <td><a href="syllabus/Technical syllabus/M.Tech/structure/MT_Structure_engg_Scheme.pdf"
                                    target="_blank"><strong>Scheme</strong></a></td>

                            <td><a href="syllabus/Technical syllabus/M.Tech/structure/M TECH - Structure Engineering Syllabus.pdf"
                                    target="_blank"><strong>Syllabus</strong></a></td>
                        </tr>
