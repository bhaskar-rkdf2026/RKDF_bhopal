                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if (!empty($member['photo_url'])): ?>
                                            <img src="images/Staff_Photos/<?php echo htmlspecialchars($member['photo_url']); ?>" alt="Photo of <?php echo htmlspecialchars($member['name']); ?>" class="staff-photo" onerror="this.onerror=null;this.src=' ';">
                                        <?php else: ?>
                                            N/A
                                        <?php endif; ?>
                                    </td>
