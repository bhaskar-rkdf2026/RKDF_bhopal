...
<section id="contentLeft">
	...
	<h2 class="titleDescription"><a href="#">Faculty of Social Science </a></h2>
	<p class="titleDescription">&nbsp;</p>
	<blockquote>
	 	  
	  <table width="1122" border="1" cellpadding="0" cellspacing="0">
	  <tr>
          <td colspan="6"> <span class="style7"> &nbsp; </span> </td>
          </tr>	
      <tr bgcolor="#9A9A4E">
        <td width="176" height="34"><span class="style1">Courses</span></td>
        <td width="80"><span class="style1">Sem/Year</span></td>
        <td width="71"><span class="style1">Seats</span></td>
        <td width="313"><span class="style1">Eligibility</span></td>
      </tr>
       <tr>
        <td width="176" height="46"><span class="style6">BSW</span></td>
        <td width="80"><span class="style6">6 Sem</span></td>
        <td width="71"><span class="style6">30</span></td>
        <td width="313" class="style6">Passed 10+2 or equivalent examination in
any subjects.</td>
      </tr>
	   <tr>
        <td width="176"><span class="style6">MSW

</span></td>
        <td width="80"><span class="style6">4 Sem</span></td>
        <td width="71"><span class="style6">30</span></td>
        <td width="313" class="style6">Passed Bachelor Degree of 3yrs minimum or equivalent in any subjects from recognized University by UGC/ AIU.</td>
      </tr>
	  <tr>
        <td width="176"><span class="style6">BA</span></td>
        <td width="80"><span class="style6">6 Sem</span></td>
        <td width="71"><span class="style6">180</span></td>
        <td width="313" class="style6">Passed 10+2 or equivalent examination in any subjects.</td>
      </tr>
	  <!--<tr>
	  ...
	  <tr>
        <td width="176"><span class="style6">MA<!---English-->

</span></td>
        <td width="80"><span class="style6">4 Sem</span></td>
        <td width="71"><span class="style6">70</span></td>
       <td width="313" class="style6">Passed Bachelor Degree of 3yrs minimum or equivalent in any subjects from recognized University by UGC/ AIU.</td>
      </tr>
	  <!--<tr>
	  ...
	  <tr>
	   ...
	   <table width="200" border="1">
         ...
         <tr>
		  ...
		  <tr>
           <td width="215" height="46" class="style6">&nbsp;PhD. - Sociology</td>
         <td width="419" rowspan="2"><div align="justify"><span class="style6">As per UGC Norms.</span></div></td>
         </tr>
		  <tr>
           <td width="215" height="46" class="style6">&nbsp;PhD. - English</td>
          </tr>
		  <tr>
